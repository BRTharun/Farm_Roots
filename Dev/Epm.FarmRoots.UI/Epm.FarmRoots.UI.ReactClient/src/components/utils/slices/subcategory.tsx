    ...
    async (categoryId: string, { rejectWithValue, getState }) => {
        try {
            ...
            const response = await axios.get(
                `http://localhost:5000/api/vendors/sub-categorys/${categoryId}`,
                {
                    headers: {
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(updateSubcategory.rejected, (state, action) => {
                state.status = "failed";
                state.error =
                    action.error.message || "Failed to update subcategory";
            })
            ...
            .addCase(deleteSubcategory.rejected, (state, action) => {
                state.status = "failed";
                state.error =
                    action.error.message || "Failed to delete subcategory";
            })
            ...
            .addCase(addSubcategory.rejected, (state, action) => {
                state.status = "failed";
                state.error =
                    action.error.message || "Failed to add subcategory";
            });
    },
});
