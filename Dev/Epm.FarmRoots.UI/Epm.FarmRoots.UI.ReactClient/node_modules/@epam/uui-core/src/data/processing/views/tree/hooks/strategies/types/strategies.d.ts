...
export type ExtractTreeProps<T extends Strategies, TItem, TId, TFilter = any> = Extract<UseTreeProps<TItem, TId, TFilter>, {
    type: T;
}>;
export type TreeHook<T extends Strategies> = <TItem, TId, TFilter = any>(props: ExtractTreeProps<T, TItem, TId, TFilter>, deps: any[]) => UseTreeResult<TItem, TId, TFilter>;
/**
 * useTree hook configuration.
 */
export type UseTreeProps<TItem, TId, TFilter = any> = (SyncTreeProps<TItem, TId, TFilter> | AsyncTreeProps<TItem, TId, TFilter> | LazyTreeProps<TItem, TId, TFilter>);
/**
