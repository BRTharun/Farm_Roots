 ...
 */
export interface UseCascadeSelectionServiceProps<TItem, TId> extends LoadMissingRecords<TItem, TId> {
    /**
 ...
 */
export declare function useCascadeSelectionService<TItem, TId>({ tree, loadMissingRecordsOnCheck, }: UseCascadeSelectionServiceProps<TItem, TId>): CascadeSelectionService<TItem, TId>;
//# sourceMappingURL=useCascadeSelectionService.d.ts.map