...
export type IProcessRequest = <DataResponse = any>(url: string, method: ProcessRequestMethod, data?: any, options?: ApiCallOptions<DataResponse>) => Promise<DataResponse>;
...
export declare const uuiContextTypes: {
    uuiAnalytics: PropTypes.Requireable<object>;
    uuiErrors: PropTypes.Requireable<object>;
    uuiApi: PropTypes.Requireable<object>;
    uuiModals: PropTypes.Requireable<object>;
    uuiNotifications: PropTypes.Requireable<object>;
    api: PropTypes.Requireable<object>;
    uuiUserSettings: PropTypes.Requireable<object>;
    uuiDnD: PropTypes.Requireable<object>;
    uuiApp: PropTypes.Requireable<object>;
    uuiRouter: PropTypes.Requireable<object>;
    uuiLayout: PropTypes.Requireable<object>;
    uuiLocks: PropTypes.Requireable<object>;
    history: PropTypes.Requireable<object>;
    uuiSkin: PropTypes.Requireable<object>;
};
export {};
