 ...
 */
export type SetDataSourceState<TFilter = Record<string, any>, TId = any> = (updateState: (prevState: DataSourceState<TFilter, TId>) => DataSourceState<TFilter, TId>) => void;
export declare const CascadeSelectionTypes: {
 ...
 */
export type Position<TId> = PositionType | {
    after: TId;
};
export type SortedPatchByParentId<TItem, TId> = IMap<TId, {
    top: TId[];
    bottom: TId[];
    updated: TId[];
    moved: TId[];
