...
export interface LabeledInputCoreProps extends ICanBeInvalid, IHasCX, IHasLabel, IHasChildren, ICanBeRequired, IHasValidationMessage, IHasRawProps<React.HTMLAttributes<HTMLDivElement>> {
