...
type ElementType<ArrayOrObject> = ArrayOrObject extends readonly (infer ArrayType)[] ? ArrayType : ArrayOrObject extends IMap<any, infer ValueType> ? ValueType : ArrayOrObject extends IImmutableMap<any, infer ValueType> ? ValueType : ArrayOrObject extends Record<any, infer ValueType> ? ValueType : never;
