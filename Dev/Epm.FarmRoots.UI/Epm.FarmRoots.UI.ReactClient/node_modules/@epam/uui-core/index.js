 ...
 */
const forwardRef = React__namespace.default.forwardRef;

function withMods(Component, getCx, getProps) {
    const isClassComponent = Component.prototype instanceof React__namespace.Component;
    ...
    if (!Component) {
        ...
        wrappedComponent = /* @__PURE__ */forwardRef((props, ref) => {
            ...
            return React__namespace.createElement(Component, allProps);
        });
    }
        ...
        wrappedComponent = (props) => React__namespace.createElement(Component, applyMods(props));
    }
...
const cx = (...args) => {
    return classNames__default.default(...args);
};
...
const UuiContext = /* @__PURE__ */React.createContext({});

class DragGhost extends React__namespace.Component {
    constructor() {
        super(...arguments);
        this.layer = null;
        this.state = {
...
function TREE_SHAKEABLE_INIT$1() {
    var _a;
    return _a = class DndActorComponent extends React__namespace.Component {
            constructor() {
                super(...arguments);
                this.state = initialState;
                this.dndRef = React__namespace.createRef();
...
class ModalContext extends BaseContext {
    ...
    show(render, parameters) {
        const ModalAdapter = class extends React__namespace.Component {
            render() {
...
class NotificationContext extends BaseContext {
    ...
    show(render, notificationParams) {
        const NotificationAdapter = class extends React__namespace.Component {
            render() {
                return render(this.props);
            }
        };
...
const useUuiServices = (props) => {
    const [result] = React.useState(() => createServices(props));
...
function ContextProvider(props) {
    ...
    return (React__namespace.default.createElement(UuiContext.Provider, { value: services },
        children,
        React__namespace.default.createElement(DragGhost, null)));
}
...
const IEditableDebouncerImpl = (props) => {
    ...
    const lastSentValue = React.useRef(props.value);
    ...
    const debouncedOnValueChange = React.useMemo(() => {
        return debounce__default.default((value) => {
    ...
    const propsToRender = React.useMemo(() => ({
        value: state.value,
 ...
 */
const IEditableDebouncer = /* @__PURE__ */React__namespace.default.memo(IEditableDebouncerImpl);
...
const uuiContextTypes = {
    uuiAnalytics: PropTypes__namespace.object,
    uuiErrors: PropTypes__namespace.object,
    uuiApi: PropTypes__namespace.object,
    uuiModals: PropTypes__namespace.object,
    uuiNotifications: PropTypes__namespace.object,
    api: PropTypes__namespace.object,
    uuiUserSettings: PropTypes__namespace.object,
    uuiDnD: PropTypes__namespace.object,
    uuiApp: PropTypes__namespace.object,
    uuiRouter: PropTypes__namespace.object,
    uuiLayout: PropTypes__namespace.object,
    uuiLocks: PropTypes__namespace.object,
    history: PropTypes__namespace.object,
    uuiSkin: PropTypes__namespace.object,
};
...
function usePrevious(value, { compare } = {}) {
    ...
    React.useEffect(() => {
        if (compare) {
            if (!isEqual__default.default(previousValueRef.current, value)) {
        ...
        return __awaiter(this, arguments, void 0, function* ({ tree, newItemsMap, options, itemsToLoad, }) {
            ...
            while (true) {
                ...
                if (missingIds.size === 0) {
                    ...
                    if (prevMissingIds.size === missingIds.size && isEqual__default.default(prevMissingIds, missingIds)) {
                        break;
                    }
            ...
            return yield FetchingHelper.load({
                ...
                options: {
                    ...
                    loadAllChildren: (itemId) => {
                        ...
                        if (isImplicitMode) {
                            return Object.assign(Object.assign({}, loadAllConfig), { children: itemId === ROOT_ID || parents.some((parent) => isEqual__default.default(parent, itemId)) });
                        }
                        ...
                        const shouldLoadChildrenAfterSearch = (!!((_a = dataSourceState.search) === null || _a === void 0 ? void 0 : _a.length)
                            && (parents.some((parent) => isEqual__default.default(parent, itemId))
                        ...
                        const shouldLoadAllChildren = isRoot
                            || isEqual__default.default(itemId, checkedId)
        ...
        if (isChecked) {
            ...
            if (checkedIdsMap.size) {
                for (const [id] of checkedIdsMap) {
                    if (isEqual__default.default(id, checkedId)) {
                        continue;
                    }
                    const path = Tree.getPathById(id, tree);
                    if (path.some((item) => isEqual__default.default(item.id, checkedId))) {
...
function useLoadData$1(props) {
    ...
    const promiseInProgressRef = React.useRef();
    const loadMissingImpl = React.useCallback((_a) => __awaiter(this, [_a], void 0, function* ({ using, tree, loadAllChildren = () => ({ nestedChildren: true, children: false }), isLoadStrict, dataSourceState, }) {
        var _b;
    ...
    const loadMissing = React.useCallback(({ tree, using, abortInProgress, loadAllChildren, isLoadStrict, dataSourceState, }) => {
    ...
    const loadMissingOnCheck = React.useCallback((currentTree, id, isChecked, isRoot) => __awaiter(this, void 0, void 0, function* () {
        const isImplicitMode = cascadeSelection === CascadeSelectionTypes.IMPLICIT;
        if (!cascadeSelection && !isRoot) {
            return currentTree;
        }
        ...
        const { tree: treeWithMissingRecords } = yield loadMissing({
            ...
            loadAllChildren: (itemId) => {
                ...
                // So, they should be compared not by reference, but by value.
                const shouldLoadAllChildren = isRoot
                    || isEqual__default.default(itemId, id)
                    || shouldLoadChildrenAfterSearch;
                return {
...
function useDataSourceStateWithDefaults({ dataSourceState }) {
    const dataSourceStateRef = React.useRef(getDataSourceStateWithDefaults(dataSourceState));
...
function useItemsStatusCollector({ itemsStatusMap, complexIds, getId, itemsStatusCollector, dataSourceState, patch, }, deps) {
    const statusCollector = React.useMemo(() => {
...
function useItemsStorage({ itemsMap: outerItemsMap, setItems, items, params }) {
    var _a;
    const itemsStorage = React.useMemo(() => {
        if (!outerItemsMap) {
            return new ItemsStorage({ items, params });
        }
        return null;
    }, [outerItemsMap, items]);
    const [itemsMap, setItemsMap] = React.useState(outerItemsMap !== null && outerItemsMap !== void 0 ? outerItemsMap : itemsStorage === null || itemsStorage === void 0 ? void 0 : itemsStorage.getItemsMap());
    React.useEffect(() => {
        if (itemsStorage) {
...
function usePatchTree({ tree, patch, getNewItemPosition = () => PatchOrdering.TOP, getItemTemporaryOrder, fixItemBetweenSortings = true, isDeleted, sorting, sortBy, }) {
    ...
    const patchAtLastSort = React.useMemo(() => {
        return prevPatch === null ? newMap({ complexIds: params.complexIds }) : patch;
    }, [sorting]);
    const sortedPatch = React.useMemo(() => getSortedPatchByParentId(tree.visible, patch, fixItemBetweenSortings ? patchAtLastSort : patch, getNewItemPosition, getItemTemporaryOrder, sortBy, sorting, isDeleted, fixItemBetweenSortings), [patch, sorting, fixItemBetweenSortings]);
    const patchedTree = React.useMemo(() => {
    ...
    const applyPatch = React.useCallback((updated) => {
...
const isSelectedOrCheckedChanged = (dataSourceState, prevDataSourceState) => {
    var _a;
    return (((_a = dataSourceState.checked) === null || _a === void 0 ? void 0 : _a.length) && !isEqual__default.default(prevDataSourceState === null || prevDataSourceState === void 0 ? void 0 : prevDataSourceState.checked, dataSourceState.checked)) || (dataSourceState.selectedId !== null
...
function useUpdateTree({ tree, shouldUpdate, update, }, deps) {
    ...
    const updatedTree = React.useMemo(() => {
...
const sortingWasChanged = (prevValue, newValue) => !isEqual__default.default(newValue === null || newValue === void 0 ? void 0 : newValue.sorting, prevValue === null || prevValue === void 0 ? void 0 : prevValue.sorting);
const filterWasChanged = (prevValue, newValue) => !isEqual__default.default(newValue === null || newValue === void 0 ? void 0 : newValue.filter, prevValue === null || prevValue === void 0 ? void 0 : prevValue.filter);
...
function useLazyFetchingAdvisor({ dataSourceState, filter, forceReload, backgroundReload, showSelectedOnly, }, deps = []) {
    const depsChanged = useDepsChanged(deps);
    const areMoreRowsNeeded = React.useCallback((prevValue, newValue) => {
    ...
    const shouldRefetch = React.useMemo(() => !prevDataSourceState
        || !isEqual__default.default(prevFilter, filter)
...
function useLazyTree(_a, deps) {
    ...
    const api = React.useMemo(() => itemsStatusCollector.watch(props.api), [itemsStatusCollector, props.api]);
    const blankTree = React.useMemo(() => TreeState.blank({ getId, getParentId, getChildCount, complexIds }, itemsMap, setItems), deps);
    const [treeWithData, setTreeWithData] = React.useState(blankTree);
    const prevDataSourceState = usePrevious(dataSourceState);
    ...
    const loadMissingRecordsOnCheck = React.useCallback((id, isChecked, isRoot) => __awaiter(this, void 0, void 0, function* () {
...
function useLoadData({ tree, api, dataSourceState, showSelectedOnly, isLoaded: isPrevouslyLoaded, complexIds, getId, onForceReloadComplete, forceReload, patch, itemsStatusCollector: externalItemsStatusCollector, itemsStatusMap, }, deps) {
    ...
    const [loadedTree, setLoadedTree] = React.useState(tree);
    const [isLoaded, setIsLoaded] = React.useState(isPrevouslyLoaded);
    const [isLoading, setIsLoading] = React.useState(false);
    const [isFetching, setIsFetching] = React.useState(false);
    const itemsStatusCollector = useItemsStatusCollector({
        itemsStatusMap,
    ...
    const watchedApi = React.useMemo(() => itemsStatusCollector.watch(api), [itemsStatusCollector, api]);
    const loadData = React.useCallback((sourceTree_1, ...args_1) => __awaiter(this, [sourceTree_1, ...args_1], void 0, function* (sourceTree, dsState = {}) {
...
function useAsyncTree(props, deps) {
    ...
    const [incommingTree, setIncommingTree] = React.useState(baseTree);
...
function useSyncTree(_a, deps) {
    ...
    const [triggerValue, trigger] = React.useState(false);
...
function useTree(props, deps) {
    ...
    const useStrategy = React.useMemo(() => strategies[props.type], [props.type]);
...
function useCheckingService({ tree, getParentId, dataSourceState, setDataSourceState, cascadeSelection, getRowOptions, rowOptions, getCompleteTreeForCascadeSelection, getItemStatus, }) {
    ...
    const checkingInfoById = React.useMemo(() => buildParentsLookup(checked, tree, getParentId), [tree, getParentId, checked]);
    const { idsByKey: checkedByKey, someChildInIdsByKey: someChildCheckedByKey } = checkingInfoById;
    const isRowChecked = React.useCallback((row) => {
    ...
    const isRowChildrenChecked = React.useCallback((row) => {
        var _a;
    ...
    const isItemCheckable = React.useCallback((id, item) => {
        var _a, _b;
        if (item === NOT_FOUND_RECORD) {
            if (!getItemStatus) {
                return true;
    ...
    const isItemUnknown = React.useCallback((id) => {
        const item = tree.getById(id);
        if (item !== NOT_FOUND_RECORD) {
            return false;
        }
    ...
    const handleCheck = React.useCallback((isChecked, checkedId, isRoot) => __awaiter(this, void 0, void 0, function* () {
    ...
    const handleOnCheck = React.useCallback((rowProps) => {
...
function useFoldingService({ dataSourceState, setDataSourceState, isFoldedByDefault, getId, }) {
    ...
    const isFolded = React.useCallback((item) => {
        var _a;
    ...
    const handleOnFold = React.useCallback((rowProps) => {
        setDataSourceState((dsState) => {
            var _a, _b;
...
function useFocusService({ setDataSourceState, }) {
    const handleOnFocus = React.useCallback((focusIndex) => {
...
function useSelectingService({ tree, getParentId, dataSourceState, setDataSourceState, }) {
    ...
    const selectingInfoById = React.useMemo(() => buildParentsLookup(selectedId === null ? [] : [selectedId], tree, getParentId), [tree, getParentId, selectedId]);
    const { idsByKey: selectedByKey, someChildInIdsByKey: someChildSelectedByKey } = selectingInfoById;
    const isRowSelected = React.useCallback((row) => {
        return !!selectedByKey[idToKey(row.id)];
    }, [selectedByKey]);
    const isRowChildSelected = React.useCallback((row) => {
        var _a;
        return (_a = someChildSelectedByKey[idToKey(row.id)]) !== null && _a !== void 0 ? _a : false;
    }, [someChildSelectedByKey]);
    const handleOnSelect = React.useCallback((rowProps) => {
...
function useCascadeSelectionService({ tree, loadMissingRecordsOnCheck = () => __awaiter(this, void 0, void 0, function* () { return tree; }), }) {
    const getCompleteTreeForCascadeSelection = React.useCallback((checkedId, isChecked, isRoot) => __awaiter(this, void 0, void 0, function* () {
...
function useDataRowProps({ tree, getId, dataSourceState, getRowOptions, rowOptions, isFolded, handleOnCheck, handleOnSelect, handleOnFocus, handleOnFold, isRowSelected, isRowChildSelected, isRowChecked, isRowChildrenChecked, getEstimatedChildrenCount, }) {
    const updateRowOptions = React.useCallback((row) => {
        var _a, _b, _c;
    ...
    const getRowProps = React.useCallback((item, index) => {
        const id = getId(item);
    ...
    const getEmptyRowProps = React.useCallback((id, index = 0, path = null) => {
        var _a, _b;
    ...
    const getLoadingRowProps = React.useCallback((id, index = 0, path = null) => {
    ...
    const getUnknownRowProps = React.useCallback((id, index = 0, path = null) => {
        var _a;
    ...
    return React.useMemo(() => ({ getRowProps, getEmptyRowProps, getLoadingRowProps, getUnknownRowProps, updateRowOptions }), [getRowProps, getEmptyRowProps, getLoadingRowProps, getUnknownRowProps, updateRowOptions]);
}
...
function useBuildRows({ tree, dataSourceState, getEstimatedChildrenCount, getMissingRecordsCount, cascadeSelection, maxVisibleRowIndex, getRowProps, getLoadingRowProps, isLoading = false, }) {
    ...
    return React.useMemo(() => buildRows(), [tree, dataSourceState.folded, dataSourceState.checked, isLoading, dataSourceState.foldAll]);
}

function useSelectAll(props) {
    const isSelectAllEnabled = React.useMemo(() => props.selectAll === undefined ? true : props.selectAll, [props.selectAll]);
...
function usePinnedRows({ rows, pinned, pinnedByParentId, }) {
    const getLastPinnedBeforeRow = React.useCallback((row, pinnedIndexes) => {
    ...
    const getLastHiddenPinnedByParent = React.useCallback((row, alreadyAdded) => {
    ...
    const withPinnedRows = React.useCallback((allRows) => {
        if (!allRows.length)
            return [];
...
function useDataRows(props) {
    ...
    const maxVisibleRowIndex = React.useMemo(() => dataSourceState.topIndex + dataSourceState.visibleCount, [tree, dataSourceState.topIndex, dataSourceState.visibleCount]);
    const getEstimatedChildrenCount = React.useCallback((id) => {
        if (id === undefined) {
    ...
    const getMissingRecordsCount = React.useCallback((id, totalRowsCount, loadedChildrenCount) => {
    ...
    const clearAllChecked = React.useCallback(() => handleSelectAll(false), [handleSelectAll]);
    return {
        listProps,
        rows,
 ...
 */
const useLayoutEffectSafeForSsr = typeof window !== 'undefined' ? React.useLayoutEffect : React.useEffect;
...
function useVirtualList(props) {
    ...
    const [estimatedHeight, setEstimatedHeight] = React__namespace.useState(0);
    const [listOffset, setListOffset] = React__namespace.useState();
    const [scrolledTo, setScrolledTo] = React__namespace.useState(null);
    const listContainer = React__namespace.useRef();
    const scrollContainer = React__namespace.useRef();
    const rowHeights = React__namespace.useRef([]);
    const rowOffsets = React__namespace.useRef([]);
    const virtualListInfo = React__namespace.useMemo(() => ({
    ...
    const getTopIndexAndVisibleCountOnScroll = React__namespace.useCallback(() => {
        var _a, _b;
    ...
    const getNewRowsOnScroll = React__namespace.useCallback(() => {
    ...
    const scrollContainerToPosition = React__namespace.useCallback((scrollTo) => {
    ...
    const scrollToIndex = React__namespace.useCallback((scrollTo) => {
        var _a, _b;
    ...
    const offsetY = React__namespace.useMemo(() => getOffsetYForIndex(value === null || value === void 0 ? void 0 : value.topIndex, rowOffsets.current, listOffset), [rowOffsets.current, listOffset, value === null || value === void 0 ? void 0 : value.topIndex]);
...
function useScrollShadows({ root }) {
    const [vertical, setVertical] = React__namespace.useState({ top: false, bottom: false });
    const [horizontal, setHorizontal] = React__namespace.useState({ left: false, right: false });
    const resizeObserver = React__namespace.useRef();
    ...
    const updateScrollShadows = React__namespace.useCallback(() => {
        if (!root)
            return;
...
const normalizeTableStateValue = (newValue, prevValue, filters) => {
    ...
    if ((prevValue === null || prevValue === void 0 ? void 0 : prevValue.page) !== undefined && !isEqual__default.default(prevValue === null || prevValue === void 0 ? void 0 : prevValue.filter, newFilter)) {
...
const useTableStateImpl = (params) => {
    var _a;
    const context = useUuiContext();
    const [presets, setPresets] = React.useState((_a = params === null || params === void 0 ? void 0 : params.initialPresets) !== null && _a !== void 0 ? _a : []);
    const setColumnsConfig = React.useCallback((columnsConfig) => {
        params.onValueChange((val) => (Object.assign(Object.assign({}, val), { columnsConfig })));
    }, []);
    const setFiltersConfig = React.useCallback((filtersConfig) => {
    ...
    const choosePreset = React.useCallback((preset) => {
    ...
    const getNewPresetOrder = React.useCallback(() => {
        var _a;
        const maxOrder = (_a = orderBy(presets, (i) => i.order, 'desc')[0]) === null || _a === void 0 ? void 0 : _a.order;
        return getOrderBetween(maxOrder, null);
    }, [presets]);
    const createPreset = React.useCallback((preset) => __awaiter(void 0, void 0, void 0, function* () {
        var _b;
    ...
    const createNewPreset = React.useCallback((name) => {
    ...
    const hasPresetChanged = React.useCallback((preset) => {
        const currentTableStateValue = params.value;
        return (!isEqual__default.default(preset.filter, currentTableStateValue.filter)
            || !isEqual__default.default(preset.columnsConfig, currentTableStateValue.columnsConfig)
            || !isEqual__default.default(preset.sorting, currentTableStateValue.sorting)
            || !isEqual__default.default(preset.viewState, currentTableStateValue.viewState));
    }, [params.value]);
    const duplicatePreset = React.useCallback((preset) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const deletePreset = React.useCallback((preset) => {
        const removePreset = () => {
    ...
    const updatePreset = React.useCallback((preset) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const getPresetLink = React.useCallback((preset) => {
    ...
    const setTableState = React.useCallback((newValue) => {
...
const useTableState = (params) => {
    const context = useUuiContext();
    const externalValue = React.useRef(params.value);
    const [tableStateValue, setTableStateValue] = React.useState(() => {
        var _a;
    ...
    const getTableStateValue = () => {
        ...
        urlKeys.forEach((urlKey) => {
            if (!isEqual__default.default(valueFromUrl[urlKey], tableStateValue[urlKey]) || !(urlKey in tableStateValue)) {
    ...
    const onValueChange = React.useCallback((update) => {
...
function useResizeObserver(props) {
    const onResize = React.useMemo(() => {
        ...
        return debounce__default.default(props.onResize, props.delay, { leading: false, trailing: true });
    }, [props.delay, props.onResize]);
    const resizeObserver = React.useMemo(() => new ResizeObserver(onResize), [onResize]);
...
class AsyncDataSource extends ArrayDataSource {
    ...
    useView(value, onValueChange, options, deps = []) {
        ...
        const forceUpdate = useForceUpdate();
        // eslint-disable-next-line react-hooks/rules-of-hooks
        const [itemsMap, setItemsMap] = React.useState(this.itemsStorage.getItemsMap());
...
function useForm(props) {
    const context = useUuiContext();
    const initialForm = React.useRef({
        isChanged: false,
        isInProgress: false,
        form: props.value,
    ...
    const prevFormValue = React.useRef(props.value);
    const formState = React.useRef(initialForm.current);
    const forceUpdate = useForceUpdate();
    ...
    const handleSave = React.useCallback((isSavedBeforeLeave) => {
        let savePromise;
    ...
    const removeUnsavedChanges = React.useCallback(() => {
        context.uuiUserSettings.set(props.settingsKey, null);
    }, [context.uuiUserSettings, props.settingsKey]);
    const handleLeave = React.useCallback((nextLocation, currentLocation) => __awaiter(this, void 0, void 0, function* () {
    ...
    const lens = React.useMemo(() => new LensBuilder({
    ...
    React.useEffect(() => {
        ...
        if (!unsavedChanges || !props.loadUnsavedChanges || isEqual__default.default(unsavedChanges, initialForm.current.form))
            return;
        props
            .loadUnsavedChanges()
    ...
    React.useEffect(() => {
        if (!isEqual__default.default(props.value, prevFormValue.current)) {
    ...
    const handleFormUpdate = (update, options) => updateFormState((currentState) => {
        ...
        const isChanged = !isEqual__default.default(initialForm.current.form, newForm);
        if (isChanged === true) {
            block();
        }
        else {
    ...
    const handleUndo = React.useCallback(() => updateFormState((currentState) => {
    ...
    const handleRedo = React.useCallback(() => updateFormState((currentState) => {
        const { formHistory, historyIndex } = currentState;
    ...
    const validate$1 = React.useCallback(() => {
    ...
    const handleReplaceValue = React.useCallback((value) => {
    ...
    const setServerValidationState = React.useCallback((value) => {
        updateFormState((currentValue) => {
...
function Form(_a) {
    ...
    return React__namespace.default.createElement(React__namespace.default.Fragment, null, renderForm(useFormProps));
}
...
function useUuiServicesSsr(props) {
    ...
    const nextRouterWithAdapter = React.useMemo(() => new NextRouterAdapter(router), [router]);
...
const useNextAppRouter = ({ router, pathname, searchParams, }) => {
    const appRouterAdapter = React.useMemo(() => new NextAppRouterAdapter(router), [router]);
...
exports.CascadeSelectionTypes = CascadeSelectionTypes;
exports.CompositeKeysMap = CompositeKeysMap;
exports.ContextProvider = ContextProvider;
exports.DndActor = DndActor;
exports.DndContext = DndContext;
exports.DragGhost = DragGhost;
exports.EMPTY = EMPTY;
exports.ErrorContext = ErrorContext;
exports.FAILED_RECORD = FAILED_RECORD;
exports.FULLY_LOADED = FULLY_LOADED;
exports.FetchingHelper = FetchingHelper;
exports.Form = Form;
exports.GAListener = GAListener;
exports.HistoryAdaptedRouter = HistoryAdaptedRouter;
exports.IEditableDebouncer = IEditableDebouncer;
exports.ItemsMap = ItemsMap;
exports.ItemsStorage = ItemsStorage;
exports.LOADED_RECORD = LOADED_RECORD;
exports.LOADING_RECORD = LOADING_RECORD;
exports.LayoutContext = LayoutContext;
exports.LazyDataSource = LazyDataSource;
exports.Lens = Lens;
exports.Lock = Lock;
exports.LockContext = LockContext;
exports.ModalContext = ModalContext;
exports.ModalOperationCancelled = ModalOperationCancelled;
exports.NOT_FOUND_RECORD = NOT_FOUND_RECORD;
exports.NextAppRouterAdapter = NextAppRouterAdapter;
exports.NextRouterAdapter = NextRouterAdapter;
exports.NotificationContext = NotificationContext;
exports.PARTIALLY_LOADED = PARTIALLY_LOADED;
exports.PENDING_RECORD = PENDING_RECORD;
exports.PatchOrdering = PatchOrdering;
exports.Router6AdaptedRouter = Router6AdaptedRouter;
exports.StubAdaptedRouter = StubAdaptedRouter;
exports.Tree = Tree;
exports.UuiContext = UuiContext;
exports.UuiError = UuiError;
exports.applyColumnsConfig = applyColumnsConfig;
exports.arrayToMatrix = arrayToMatrix;
exports.blankValidationState = blankValidationState;
exports.blurFocusedElement = blurFocusedElement;
exports.clearEmptyValueFromRecord = clearEmptyValueFromRecord;
exports.cloneMap = cloneMap;
exports.closestTargetParentByCondition = closestTargetParentByCondition;
exports.createSkinComponent = createSkinComponent;
exports.cx = cx;
...
exports.getBeforeUnloadSingletone = getBeforeUnloadSingletone;
exports.getCalculatedValue = getCalculatedValue;
exports.getColumnsConfig = getColumnsConfig;
exports.getCookie = getCookie;
exports.getDecimalLength = getDecimalLength;
exports.getFilterPredicate = getFilterPredicate;
exports.getMinMaxValidatedValue = getMinMaxValidatedValue;
exports.getOffset = getOffset;
exports.getOrderBetween = getOrderBetween;
exports.getOrderComparer = getOrderComparer;
exports.getRouter6BlockFn = getRouter6BlockFn;
exports.getScrollParentOfEventTarget = getScrollParentOfEventTarget;
exports.getSearchFilter = getSearchFilter;
exports.getSeparatedValue = getSeparatedValue;
exports.i18n = i18n;
exports.indexToOrder = indexToOrder;
exports.isAnyParentHasClass = isAnyParentHasClass;
exports.isClientSide = isClientSide;
exports.isEventTargetInsideClickable = isEventTargetInsideClickable;
exports.isEventTargetInsideDraggable = isEventTargetInsideDraggable;
exports.isEventTargetInsideInput = isEventTargetInsideInput;
exports.isFocusReceiverInsideFocusLock = isFocusReceiverInsideFocusLock;
exports.isMobile = isMobile;
exports.isUrl = isUrl;
exports.labelMod = labelMod;
exports.maxOrderStr = maxOrderStr;
exports.mergeValidation = mergeValidation;
exports.minOrderStr = minOrderStr;
exports.mobilePopperModifier = mobilePopperModifier;
exports.newMap = newMap;
exports.orderBy = orderBy;
exports.prependHttp = prependHttp;
exports.preventDefaultIfTargetFocused = preventDefaultIfTargetFocused;
exports.queryToSearch = queryToSearch;
exports.range = range;
exports.releasePointerCaptureOnEventTarget = releasePointerCaptureOnEventTarget;
exports.runDataQuery = runDataQuery;
exports.searchToQuery = searchToQuery;
exports.setCookie = setCookie;
exports.simplifyPredicates = simplifyPredicates;
exports.useArrayDataSource = useArrayDataSource;
exports.useAsyncDataSource = useAsyncDataSource;
exports.useCascadeSelectionService = useCascadeSelectionService;
exports.useColumnsConfig = useColumnsConfig;
exports.useDataRows = useDataRows;
exports.useFoldingService = useFoldingService;
exports.useForceUpdate = useForceUpdate;
exports.useForm = useForm;
exports.useLayer = useLayer;
exports.useLayoutEffectSafeForSsr = useLayoutEffectSafeForSsr;
exports.useLazyDataSource = useLazyDataSource;
exports.useLazyFetchingAdvisor = useLazyFetchingAdvisor;
exports.useNextAppRouter = useNextAppRouter;
exports.usePrevious = usePrevious;
exports.useResizeObserver = useResizeObserver;
exports.useScrollShadows = useScrollShadows;
exports.useTableState = useTableState;
exports.useTableStateImpl = useTableStateImpl;
exports.useTree = useTree;
exports.useUuiContext = useUuiContext;
exports.useUuiError = useUuiError;
exports.useUuiServices = useUuiServices;
exports.useUuiServicesSsr = useUuiServicesSsr;
exports.useVirtualList = useVirtualList;
exports.uuiContextTypes = uuiContextTypes;
exports.uuiDataTableHeaderCell = uuiDataTableHeaderCell;
exports.uuiDndState = uuiDndState;
exports.uuiElement = uuiElement;
exports.uuiMarkers = uuiMarkers;
exports.uuiMod = uuiMod;
exports.uuiScrollShadows = uuiScrollShadows;
exports.validate = validate;
exports.validateServerErrorState = validateServerErrorState;
