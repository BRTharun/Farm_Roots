...
class Text extends React__namespace.Component {
    ...
    render() {
        return (React__namespace.createElement("div", Object.assign({ onClick: this.props.onClick && this.onClick, className: uuiCore.cx(this.props.cx, css$J.container), ref: this.props.forwardedRef }, this.props.rawProps), this.props.children));
    }
}
Text.contextType = uuiCore.UuiContext;

class RichTextView extends React__namespace.Component {
    getViewByProps(content) {
        return React__namespace.createElement("div", Object.assign({ dangerouslySetInnerHTML: { __html: content }, className: uuiCore.cx(this.props.cx) }, this.props.rawProps));
    }
    getViewByChildren(content) {
        return (React__namespace.createElement("div", Object.assign({ className: uuiCore.cx(this.props.cx) }, this.props.rawProps), content));
    }
    render() {
...
function FlexSpacer(props) {
    return React__namespace.createElement("div", { className: css$I.flexSpacer });
}

const FlexCell = /* @__PURE__ */React__namespace.forwardRef((props, ref) => {
    var _a;
    ...
    return (React__namespace.createElement("div", Object.assign({ className: uuiCore.cx(props.cx), onClick: props.onClick ? (e) => !uuiCore.isEventTargetInsideClickable(e) && props.onClick(e) : undefined }, props.rawProps, { style: actualStyle, ref: ref }), props.children));
});
...
const FlexRow = /* @__PURE__ */React__namespace.forwardRef((props, ref) => {
    var _a;
    return (React__namespace.createElement("div", Object.assign({ ref: ref, onClick: props.onClick ? (e) => !uuiCore.isEventTargetInsideClickable(e) && props.onClick(e) : undefined, className: uuiCore.cx('uui-flex-row', props.cx, css$H.container, props.onClick && uuiCore.uuiMarkers.clickable, css$H['align-items-' + (props.alignItems === undefined ? 'center' : props.alignItems)], (props === null || props === void 0 ? void 0 : props.justifyContent) && css$H[`justify-content-${props.justifyContent}`]) }, props.rawProps, { style: Object.assign({ columnGap: props.columnGap && `${props.columnGap}px`, rowGap: props.rowGap && `${props.rowGap}px` }, (_a = props.rawProps) === null || _a === void 0 ? void 0 : _a.style) }), props.children));
});

var css$G = {"container":"mM4U8f"};

class VPanel extends React__namespace.Component {
    constructor() {
        super(...arguments);
        this.handleClick = (e) => {
            this.props.onClick && !uuiCore.isEventTargetInsideClickable(e) && this.props.onClick(e);
            this.context.uuiAnalytics.sendEvent(this.props.clickAnalyticsEvent);
        };
    }
    render() {
        return (React__namespace.createElement("div", Object.assign({ onClick: this.props.onClick && this.handleClick, style: this.props.style, className: uuiCore.cx(this.props.cx, css$G.container, this.props.onClick && uuiCore.uuiMarkers.clickable), ref: this.props.forwardedRef }, this.props.rawProps), this.props.children));
    }
}
VPanel.contextType = uuiCore.UuiContext;
...
const Svg = /* @__PURE__ */React__namespace.forwardRef((props, ref) => {
    if (!props.svg)
        return null;
    const { svg, fillColor, height, width, } = props;
    const svgProps = Object.assign({ className: cx__default.default(props.cx), fill: fillColor }, props.rawProps);
    if (height !== undefined)
        svgProps.height = height;
    if (width !== undefined)
        svgProps.width = width;
    return React__namespace.createElement(svg, Object.assign(Object.assign({}, svgProps), { ref }));
});

const IconContainer = /* @__PURE__ */React__namespace.forwardRef((props, ref) => {
    var _a, _b;
    const isClickable = !props.isDisabled && props.onClick;
    return (React__namespace.createElement("div", Object.assign({ className: uuiCore.cx(css$F.container, uuiCore.uuiElement.icon, props.isDisabled ? uuiCore.uuiMod.disabled : uuiCore.uuiMod.enabled, isClickable && uuiCore.uuiMarkers.clickable, props.cx, (_a = props.rawProps) === null || _a === void 0 ? void 0 : _a.className), ref: ref, onClick: isClickable ? props.onClick : undefined, tabIndex: isClickable ? props.tabIndex : undefined, style: Object.assign(Object.assign({}, props.style), (_b = props.rawProps) === null || _b === void 0 ? void 0 : _b.style) }, props.rawProps),
        React__namespace.createElement(Svg, { svg: props.icon, width: props.size, height: props.size, cx: uuiCore.cx(props.flipY && css$F.flipY, props.rotate && css$F['rotate-' + props.rotate]) })));
});
...
const Accordion = /* @__PURE__ */React__namespace.default.forwardRef((props, ref) => {
    ...
    const renderHeader = () => {
        var _a;
        const isAccordionOpened = isOpened();
        return (React__namespace.default.createElement("div", Object.assign({ onKeyDown: !props.isDisabled ? handleKeyDown : undefined, onClick: !props.isDisabled ? toggleAccordion : undefined, tabIndex: !props.isDisabled ? 0 : -1, className: uuiCore.cx(uuiAccordion.toggler, isAccordionOpened && uuiCore.uuiMod.opened, props.isDisabled && uuiCore.uuiMod.disabled) }, props.rawProps),
            React__namespace.default.createElement("div", { className: uuiCore.cx(uuiAccordion.toggleContainer) },
                props.renderTitle ? props.renderTitle(isAccordionOpened) : React__namespace.default.createElement("div", { className: uuiCore.cx(uuiAccordion.title) }, props.title), (_a = props.renderAdditionalItems) === null || _a === void 0 ? void 0 :
                _a.call(props, isAccordionOpened),
                props.dropdownIcon !== null && (React__namespace.default.createElement(IconContainer, { icon: props.dropdownIcon, flipY: isAccordionOpened, cx: [props.isDisabled && uuiCore.uuiMod.disabled, css$E.arrow] })))));
    };
    const renderBody = () => (React__namespace.default.createElement("div", { className: uuiAccordion.body, role: "region" }, props.children));
    const isAccordionOpened = isOpened();
    return (React__namespace.default.createElement("div", { ref: ref, "aria-disabled": props.isDisabled, "aria-expanded": isAccordionOpened, className: uuiCore.cx(uuiAccordion.container, css$E.container, isAccordionOpened && !props.isDisabled && uuiCore.uuiMod.opened, props.isDisabled && uuiCore.uuiMod.disabled, props.cx) },
        renderHeader(),
...
const LabeledInput = /* @__PURE__ */React__namespace.forwardRef((props, ref) => {
    var _a;
    ...
    const getSideNote = (sideNote) => {
        return (typeof sideNote === 'string')
            ? (React__namespace.createElement("div", { className: uuiLabeledInput.sideNote }, sideNote)) : sideNote;
    };
    const getCharCounter = () => {
        var _a;
        return (React__namespace.createElement("div", { className: uuiLabeledInput.charCounter }, `${((_a = props.value) === null || _a === void 0 ? void 0 : _a.length) || '0'}/${props.maxLength}`));
    };
    const getInvalidSection = () => {
        const isCharCounterAllow = props.charCounter && props.maxLength;
        return (React__namespace.createElement(FlexRow, { alignItems: "top", columnGap: 12 },
            React__namespace.createElement("div", { role: "alert", className: uuiCore.uuiElement.invalidMessage }, props.validationMessage),
    ...
    const getFootnoteSection = () => {
        ...
        return (React__namespace.createElement(FlexRow, { alignItems: "top", columnGap: 12 },
            React__namespace.createElement("div", { className: uuiLabeledInput.footNote }, props.footnote),
            isCharCounterAllow && getCharCounter()));
    };
    return (React__namespace.createElement("div", Object.assign({ className: uuiCore.cx(css$D.container, props.cx), ref: ref }, props.rawProps),
        React__namespace.createElement("div", { className: uuiCore.cx(uuiCore.labelMod[props.labelPosition ? props.labelPosition : 'top']) },
            props.label && (React__namespace.createElement("div", { className: css$D.labelWrapper },
                React__namespace.createElement("label", { htmlFor: props.htmlFor, className: uuiCore.uuiElement.label, dir: (_a = props === null || props === void 0 ? void 0 : props.rawProps) === null || _a === void 0 ? void 0 : _a.dir },
                    props.label,
                    props.isRequired && React__namespace.createElement("span", { className: uuiLabeledInput.asterisk }, "*"),
                    props.info && Tooltip && (React__namespace.createElement(Tooltip, { content: props.info },
                        React__namespace.createElement(IconContainer, { icon: props.infoIcon, cx: uuiLabeledInput.infoIcon }))),
                    isCanBeOptional && (React__namespace.createElement("div", { className: css$D.optionalFieldWrapper },
                        React__namespace.createElement("div", { className: uuiLabeledInput.optional }, i18n.labeledInput.optionalFieldLabel)))),
                props.sidenote && (React__namespace.createElement(React__namespace.Fragment, null,
                    React__namespace.createElement(FlexSpacer, null),
                    getSideNote(props.sidenote))))),
            React__namespace.createElement("div", { className: props.labelPosition === 'left' ? css$D.rightChildrenPosition : undefined }, props.children)),
...
const ControlGroup = /* @__PURE__ */React__namespace.forwardRef((props, ref) => {
    return (React__namespace.createElement("div", Object.assign({ role: "group", className: uuiCore.cx(css$C.container, props.cx), ref: ref }, props.rawProps), props.children));
});
...
function Tree(props) {
    ...
    if (rows.length === 0)
        return null;
    return React__namespace.createElement(React__namespace.Fragment, null, rows.map((i) => props.renderRow(i)));
}
...
const Blocker = /* @__PURE__ */React.forwardRef((props, ref) => {
    const transitionRef = React__namespace.default.createRef();
    return (React__namespace.default.createElement("div", Object.assign({ className: uuiCore.cx(css$B.container, classNames.container, props.cx), style: { minHeight: props.isEnabled && props.spacerHeight ? `${props.spacerHeight}px` : undefined }, ref: ref, role: "status", "aria-live": "polite", "aria-busy": props.isEnabled ? 'true' : 'false', "aria-label": props.isEnabled ? 'Loading' : '' }, props.rawProps),
        React__namespace.default.createElement(reactTransitionGroup.CSSTransition, { in: props.isEnabled, nodeRef: transitionRef, classNames: uuiBlocker, timeout: { enter: 2000, exit: 1000 }, mountOnEnter: true, unmountOnExit: true },
            React__namespace.default.createElement("div", { ref: transitionRef, className: classNames.blocker }, !props.hideSpinner && props.renderSpinner && props.renderSpinner(props)))));
});
...
function useDocumentDir() {
    const [dir, setDir] = React.useState(window.document.dir);
    React.useEffect(() => {
...
const ScrollBars = /* @__PURE__ */React.forwardRef((_a, ref) => {
    ...
    const customRenderView = (_a) => {
        ...
        return rv || React__namespace.default.createElement("div", Object.assign({ style: Object.assign(Object.assign({}, innerStyle), Object.assign({ position: 'relative', flex: '1 1 auto' }, getIndent(innerStyle === null || innerStyle === void 0 ? void 0 : innerStyle.marginRight))) }, rest));
    };
    const customProps = __rest(props, ["renderView"]);
    return (React__namespace.default.createElement(reactCustomScrollbars2.Scrollbars, Object.assign({ className: uuiCore.cx(css$A.root, outerCx, props.className, hasTopShadow && uuiScrollbars.uuiShadowTop, hasBottomShadow && uuiScrollbars.uuiShadowBottom), renderView: (params) => customRenderView(params), renderTrackHorizontal: (props) => React__namespace.default.createElement("div", Object.assign({}, props, { className: uuiScrollbars.uuiTrackHorizontal })), renderTrackVertical: (props) => React__namespace.default.createElement("div", Object.assign({}, props, { className: uuiScrollbars.uuiTrackVertical })), renderThumbHorizontal: () => React__namespace.default.createElement("div", { className: uuiScrollbars.uuiThumbHorizontal }), renderThumbVertical: () => React__namespace.default.createElement("div", { className: uuiScrollbars.uuiThumbVertical }), style: Object.assign({ display: 'flex' }, outerStyle), onScroll: handleUpdateScroll, hideTracksWhenNotNeeded: true, ref: bars }, customProps, rawProps)));
});
...
const layoutItems = (items, containerWidth, itemsWidth, itemsGap, previousCollapsedContainerPriority) => {
    ...
    const itemsByPriority = uuiCore.orderBy(items, ({ priority }) => priority, 'desc');
...
const measureAdaptiveItems = (items, containerWidth, itemsWidth, itemsGap) => {
    ...
    if (result.hidden.length > 0) {
        ...
        while (collapsedContainer === null || result.maxHiddenItemPriority >= collapsedContainer.priority) {
            ...
            collapsedContainer = uuiCore.orderBy(
...
function AdaptivePanel(props) {
    const [itemsWidth, setItemsWidth] = React.useState();
    const [isChanged, setIsChanged] = React.useState(false);
    const wrapperRef = React.useRef(null);
    const displayedRowRef = React.useRef(null);
    ...
    return (React__namespace.default.createElement("div", Object.assign({}, props.rawProps, { className: cx__default.default(props.cx, css$z.mainWrapper), ref: wrapperRef }),
        React__namespace.default.createElement(FlexRow, { columnGap: props === null || props === void 0 ? void 0 : props.itemsGap, ref: displayedRowRef }, renderItems())));
}
...
function Modals() {
    ...
    return (React__namespace.createElement(React__namespace.Fragment, null, context.uuiModals.getOperations().map((modalOperation) => {
        return React__namespace.createElement(modalOperation.component, modalOperation.props);
    })));
}

var css$y = {"container":"_2rY0kE"};

const ModalBlocker = /* @__PURE__ */React__namespace.default.forwardRef((props, ref) => {
    const context = React.useContext(uuiCore.UuiContext);
    React.useEffect(() => {
    ...
    return (React__namespace.default.createElement("div", Object.assign({ className: uuiCore.cx(css$y.container, props.cx), style: { zIndex: props.zIndex }, ref: ref }, props.rawProps),
        React__namespace.default.createElement("div", { className: uuiCore.uuiElement.modalBlocker, onClick: handleBlockerClick, "aria-label": "Click to close a modal" }),
        React__namespace.default.createElement(FocusLock__default.default, { autoFocus: false, returnFocus: true, disabled: props.disableFocusLock }, props.children)));
});

var css$x = {};

const PopoverArrow = /* @__PURE__ */React__namespace.default.forwardRef(({ arrowProps, placement }, ref) => {
    return React__namespace.default.createElement("div", { ref: ref, className: uuiCore.cx('uui-popover-arrow', css$x.root), style: arrowProps === null || arrowProps === void 0 ? void 0 : arrowProps.style, "data-placement": placement });
});

const DropdownContainer = /* @__PURE__ */React__namespace.forwardRef((props, ref) => {
    const { focusLock = true, returnFocus = true, persistentFocus = true, closeOnEsc = true, } = props;
    function renderDropdownContainer() {
        var _a, _b;
        return (React__namespace.createElement(VPanel, { forwardedRef: !focusLock ? ref : undefined, cx: uuiCore.cx(uuiCore.uuiElement.dropdownBody, uuiCore.uuiMarkers.lockFocus, props.cx), style: Object.assign(Object.assign({}, props.style), { minWidth: props.width, minHeight: props.height, maxHeight: props.maxHeight, maxWidth: (_a = props.maxWidth) !== null && _a !== void 0 ? _a : props.width }), rawProps: Object.assign({ tabIndex: -1 }, props.rawProps) },
            props.children,
            props.showArrow && (React__namespace.createElement(PopoverArrow, { ref: (_b = props === null || props === void 0 ? void 0 : props.arrowProps) === null || _b === void 0 ? void 0 : _b.ref, arrowProps: props === null || props === void 0 ? void 0 : props.arrowProps, placement: (props === null || props === void 0 ? void 0 : props.placement) || 'bottom-start' }))));
    }
    ...
    return focusLock
        ? (React__namespace.createElement(FocusLock__default.default, { ref: ref, returnFocus: returnFocus && { preventScroll: true }, persistentFocus: persistentFocus, lockProps: Object.assign(Object.assign({}, ({ onKeyDown: handleEscape })), props.lockProps), shards: props.shards, autoFocus: false, as: props.as }, renderDropdownContainer()))
        : renderDropdownContainer();
});

const Portal = (props) => {
    const { uuiLayout } = uuiCore.useUuiContext();
    const rootElement = props.target || uuiLayout.getPortalRoot();
    return ReactDOM__default.default.createPortal(props.children, rootElement, props.key);
};
...
const isInteractedOutsideDropdown = (e, stopNodes) => {
    ...
    const closestPopper = uuiCore.closestTargetParentByCondition(e, '.uui-popper');
...
class Dropdown extends React__namespace.Component {
    constructor(props) {
        ...
        this.handleTargetClick = (e) => {
            if (!this.props.isNotUnfoldable && !(e && uuiCore.isEventTargetInsideClickable(e))) {
        ...
        this.renderDropdownBody = ({ ref, placement, style, update, isReferenceHidden, arrowProps, }) => {
            ...
            // @ts-ignore
            return (React__namespace.createElement(FocusLock.FreeFocusInside, null,
                React__namespace.createElement("div", { role: "dialog", className: "uui-popper", "aria-hidden": !this.isOpened(), ref: setRef, style: Object.assign(Object.assign({}, style), { zIndex: this.props.zIndex != null ? this.props.zIndex : (_a = this.layer) === null || _a === void 0 ? void 0 : _a.zIndex }), "data-placement": this.getPlacement(placement) }, this.props.renderBody({
    ...
    render() {
        ...
        return (React__namespace.createElement(reactPopper.Manager, null,
            React__namespace.createElement(reactPopper.Reference, null, (targetProps) => this.renderTarget(targetProps)),
            shouldShowBody && (React__namespace.createElement(Portal, { target: this.props.portalTarget },
                React__namespace.createElement(reactPopper.Popper, { placement: this.getPlacement(this.props.placement) || 'bottom-start', strategy: "fixed", modifiers: [...defaultModifiers, ...(this.props.modifiers || [])] }, this.renderDropdownBody)))));
    }
}
Dropdown.contextType = uuiCore.UuiContext;
...
function Tooltip(props) {
    ...
    const renderTooltip = (bodyProps) => {
        var _a;
        if (isTooltipExist()) {
            return (React__namespace.createElement(DropdownContainer, Object.assign({ focusLock: false, showArrow: true, maxWidth: maxWidth !== null && maxWidth !== void 0 ? maxWidth : 300, cx: uuiCore.cx(tooltipCX, uuiCore.uuiElement.tooltipContainer) }, bodyProps),
                React__namespace.createElement("div", Object.assign({ role: "tooltip", "aria-hidden": isTooltipExist(), className: uuiCore.uuiElement.tooltipBody }, rawProps), props.content || ((_a = props.renderContent) === null || _a === void 0 ? void 0 : _a.call(props)))));
        }
        else {
            return null;
        }
    };
    const renderTarget = (props) => React__namespace.Children.map(children, (child, idx) => {
        if (idx > 0 || !React__namespace.isValidElement(child))
            return child;
        return React__namespace.cloneElement(child, { ref: props.ref });
    });
    return (React__namespace.createElement(Dropdown, Object.assign({}, props, { renderBody: (props) => renderTooltip(props), openOnHover: true, closeOnMouseLeave: closeOnMouseLeave !== null && closeOnMouseLeave !== void 0 ? closeOnMouseLeave : 'toggler', placement: props.placement || 'top', modifiers: [{ name: 'offset', options: { offset: props.offset || [0, 12] } }], renderTarget: (props) => renderTarget(props) })));
}

const ModalWindow = /* @__PURE__ */React__namespace.default.forwardRef((props, ref) => {
    return (React__namespace.default.createElement(VPanel, { style: props.style, cx: uuiCore.cx(uuiCore.uuiElement.modalWindow, props.cx), rawProps: Object.assign({ 'aria-modal': true, role: 'dialog' }, props.rawProps), forwardedRef: ref }, props.children));
});
...
function PortalRoot() {
    ...
    React__namespace.default.useLayoutEffect(() => {
        if (uuiCore.isClientSide) {
            return makePortalRootDiscoverable(ref.current, id);
        }
    }, [id]);
    return (React__namespace.default.createElement("div", { id: id, ref: ref }));
}
...
class Snackbar extends React__namespace.Component {
    constructor() {
        super(...arguments);
        this.itemsHeights = {};
    }
    ...
    renderItem(item, position) {
        ...
        const transitionRef = React__namespace.createRef();
        let className;
        if (isItemOnLeftSide) {
        ...
        return (React__namespace.createElement(reactTransitionGroup.CSSTransition, { nodeRef: transitionRef, classNames: style, timeout: 200, key: item.props.id },
            React__namespace.createElement("div", { ref: transitionRef, className: className, key: item.props.key, style: isItemOnBottom ? { bottom: position } : { top: position } },
                React__namespace.createElement("div", { className: uuiCore.cx(uuiSnackbar.item.self), ref: (node) => this.updateHeight(item, node) }, React__namespace.createElement(item.component, item.props)))));
    }
    ...
    render() {
        ...
        return (React__namespace.createElement("div", Object.assign({ className: uuiCore.cx(css$w.container, uuiSnackbar.snackbar, this.props.cx) }, this.props.rawProps, { ref: this.props.forwardedRef }),
            React__namespace.createElement(reactTransitionGroup.TransitionGroup, null,
                botLeftItems,
                botRightItems,
                topLeftItems,
                topRightItems,
...
Snackbar.contextType = uuiCore.UuiContext;

var css$v = {"container":"_7pPf9Q","no-icon":"XsGVFC","noIcon":"XsGVFC"};

class DragHandle extends React__namespace.Component {
    render() {
        const { rawProps, dragHandleIcon, isDisabled } = this.props;
        const classes = cx__default.default(this.props.cx, css$v.container, 'uui-drag-handle', !dragHandleIcon && css$v.noIcon, isDisabled && uuiCore.uuiMod.disabled);
        return (React__namespace.createElement("div", Object.assign({ className: classes }, rawProps), dragHandleIcon && React__namespace.createElement(IconContainer, { icon: dragHandleIcon, isDisabled: isDisabled })));
    }
}

var css$u = {"container":"W6C2nB"};

const Checkbox = /* @__PURE__ */React__namespace.forwardRef((props, ref) => {
    const context = uuiCore.useUuiContext();
    const handleChange = (e) => {
        !uuiCore.isEventTargetInsideClickable(e) && props.onValueChange(!props.value);
    ...
    return (React__namespace.createElement("label", Object.assign({ className: uuiCore.cx(css$u.container, uuiCore.uuiElement.checkboxContainer, props.cx, props.isDisabled && uuiCore.uuiMod.disabled, props.isReadonly && uuiCore.uuiMod.readonly, props.isInvalid && uuiCore.uuiMod.invalid, !props.isReadonly && !props.isDisabled && uuiCore.uuiMarkers.clickable), ref: ref }, props.rawProps),
        React__namespace.createElement("div", { className: uuiCore.cx(uuiCore.uuiElement.checkbox, (props.value || props.indeterminate) && uuiCore.uuiMod.checked), onFocus: props.onFocus, onBlur: props.onBlur },
            React__namespace.createElement("input", { type: "checkbox", onChange: !props.isReadonly ? handleChange : undefined, disabled: props.isDisabled, "aria-disabled": props.isDisabled || undefined, readOnly: props.isReadonly, "aria-readonly": props.isReadonly || undefined, checked: props.value || false, "aria-checked": ariaCheckedValue, required: props.isRequired, "aria-required": props.isRequired || undefined, tabIndex: props.tabIndex || props.isReadonly || props.isDisabled ? -1 : 0, id: props.id }),
            props.value && !props.indeterminate && React__namespace.createElement(IconContainer, { icon: props.icon }),
            props.indeterminate && React__namespace.createElement(IconContainer, { icon: props.indeterminateIcon })),
        label && React__namespace.createElement("div", { className: uuiCore.uuiElement.inputLabel }, label)));
});
...
function TREE_SHAKEABLE_INIT() {
    ...
    return {
        get dayjs() {
            ...
            if (dayjs__default.default.locale() !== i18n.datePicker.locale) {
                dayjs__default.default.locale(i18n.datePicker.locale);
            }
            /**
             ...
             */
            if (dayjs__default.default.localeData().firstDayOfWeek() !== 1) {
                dayjs__default.default.updateLocale(i18n.datePicker.locale, {
                    weekStart: 1,
                });
            }
...
function Day(props) {
    ...
    return (React__namespace.createElement("div", Object.assign({ onClick: selectDay, onKeyDown: (e) => e.key === 'Enter' && selectDay(), tabIndex: !isDisabled ? 0 : -1, className: uuiCore.cx([
            isPassedFilter && uuiDaySelection.clickableDay,
            isPassedFilter && uuiCore.uuiMarkers.clickable,
        ...
        React__namespace.createElement("div", { className: uuiDaySelection.day }, dayNumber)));
}
...
function Calendar(props) {
    ...
    const getDaysToRender = (days) => days.map((day, index) => {
        return (React__namespace.default.createElement("div", { className: uuiDaySelection.dayCell, key: `day-${props.month.valueOf()}-${day && day.valueOf()}-${index}` }, props.renderDay ? (props.renderDay({
            value: day,
            onValueChange: (v) => {
        ...
        })) : (React__namespace.default.createElement(Day, { value: day, onValueChange: (v) => {
                props.onValueChange(v);
    ...
    const getDaysMatrix = (currentDate) => {
        ...
        const days = Array.from({ length: dayOfLastWeekInPrevMonth }, (_, index) => {
            return (React__namespace.default.createElement("div", { className: uuiDaySelection.dayCell, tabIndex: -1, key: `day-${props.month.valueOf()}-${index}` }));
        }).concat(getDaysToRender(getDays(1, currentDate === null || currentDate === void 0 ? void 0 : currentDate.daysInMonth(), currentDate)));
        return uuiCore.arrayToMatrix(days, DAYS_COUNT_IN_WEEK);
    };
    ...
    const renderDaysTable = () => daysMatrix.map((week, index) => {
        ...
        return React__namespace.default.createElement("div", { key: key }, week.map((day) => day));
    });
    const renderWeekdays = () => {
        return uuiDayjs.dayjs.weekdaysShort(true).map((weekday, index) => (React__namespace.default.createElement("div", { key: `${weekday}-${index}`, className: uuiDaySelection.weekday }, weekday)));
    };
    return (React__namespace.default.createElement("div", Object.assign({ ref: props.forwardedRef, className: uuiCore.cx(css$t.container, uuiDaySelection.container, props.cx) }, props.rawProps),
        React__namespace.default.createElement("div", { className: uuiDaySelection.content },
            React__namespace.default.createElement("div", { className: uuiDaySelection.weekdaysContainer }, renderWeekdays()),
            React__namespace.default.createElement("div", { className: uuiDaySelection.days, style: { height: weeksHeight } }, renderDaysTable()))));
}
...
function CalendarPresets(props) {
    return (React__namespace.createElement("div", Object.assign({ ref: props.forwardedRef, className: uuiCore.cx(uuiPresets.container, props.cx) }, props.rawProps),
        React__namespace.createElement("div", { className: uuiPresets.header }, "Presets"),
        getPresets(props.presets).map((item) => (React__namespace.createElement("div", { key: item.key, className: uuiPresets.item, onClick: () => props.onPresetSet(item) }, item.name)))));
}
...
function MonthSelection(props) {
    const renderMonth = (month, index) => {
        ...
        return (React__namespace.createElement("div", { key: month, tabIndex: 0, className: uuiCore.cx(isSelected && uuiMonthSelection.currentMonth, uuiMonthSelection.month), onClick: () => props.onValueChange(props.value.month(index)), onKeyDown: (e) => { e.key === 'Enter' && props.onValueChange(props.value.month(index)); } }, month));
    };
    const MONTHS_SHORT_ARRAY = uuiDayjs.dayjs.monthsShort();
    return (React__namespace.createElement("div", Object.assign({ ref: props.forwardedRef, className: uuiCore.cx(css$s.container, uuiMonthSelection.container, props.cx) }, props.rawProps),
        React__namespace.createElement("div", { className: uuiMonthSelection.content },
            React__namespace.createElement("div", { className: uuiMonthSelection.monthContainer }, uuiCore.arrayToMatrix(MONTHS_SHORT_ARRAY, MONTH_ROW_LENGTH$1).map((monthsRow, index) => (React__namespace.createElement("div", { key: index, className: uuiMonthSelection.monthsRow }, monthsRow.map((month) => {
...
function YearSelection(props) {
    return (React__namespace.createElement("div", Object.assign({ className: uuiCore.cx(css$r.container, uuiYearSelection.container, props.cx) }, props.rawProps),
        React__namespace.createElement("div", { className: uuiYearSelection.content },
            React__namespace.createElement("div", { className: uuiYearSelection.yearContainer }, uuiCore.arrayToMatrix(getYears(props.value.year()), MONTH_ROW_LENGTH).map((yearRow, index) => (React__namespace.createElement("div", { key: index, className: uuiYearSelection.yearRow }, yearRow.map((year) => (React__namespace.createElement("div", { key: year, tabIndex: 0, className: uuiCore.cx(year === props.selectedDate.year() && uuiYearSelection.currentYear, uuiYearSelection.year), onClick: () => props.onValueChange(props.value.year(year)), onKeyDown: (e) => { e.key === 'Enter' && props.onValueChange(props.value.year(year)); } }, year))))))))));
}
...
const getFractionDigits = (formatOptions) => {
    const { maximumFractionDigits } = new Intl.NumberFormat(uuiCore.i18n.locale, formatOptions).resolvedOptions();
    return maximumFractionDigits;
};
const NumericInput = /* @__PURE__ */React__namespace.forwardRef((props, ref) => {
    ...
    const placeholderValue = React__namespace.useMemo(() => {
        if (typeof value === 'number') {
            if (formatValue)
                return formatValue(value);
            return props.disableLocaleFormatting ? value.toString() : uuiCore.getSeparatedValue(value, formatOptions, uuiCore.i18n.locale);
        }
    ...
    const context = uuiCore.useUuiContext();
    const [inFocus, setInFocus] = React__namespace.useState(false);
    ...
    const handleBlur = (event) => {
        ...
        if (inputRef.current && ((_a = event.target.validity) === null || _a === void 0 ? void 0 : _a.badInput)) {
            ...
            if (value !== null) {
                const validatedValue = uuiCore.getMinMaxValidatedValue({ value, min, max });
    ...
    const handleIncreaseValue = () => {
        let newValue = uuiCore.getCalculatedValue({ value, step, action: 'incr' });
        newValue = uuiCore.getMinMaxValidatedValue({ value: newValue, min, max });
        props.onValueChange(newValue);
    };
    const handleDecreaseValue = () => {
        let newValue = uuiCore.getCalculatedValue({ value, step, action: 'decr' });
        newValue = uuiCore.getMinMaxValidatedValue({ value: newValue, min, max });
        props.onValueChange(newValue);
    };
    ...
    React__namespace.useEffect(() => {
        var _a;
        (_a = inputRef === null || inputRef === void 0 ? void 0 : inputRef.current) === null || _a === void 0 ? void 0 : _a.addEventListener('wheel', uuiCore.preventDefaultIfTargetFocused, { passive: false });
        return () => {
            var _a;
            (_a = inputRef === null || inputRef === void 0 ? void 0 : inputRef.current) === null || _a === void 0 ? void 0 : _a.removeEventListener('wheel', uuiCore.preventDefaultIfTargetFocused);
        };
    }, []);
    const isPlaceholderColored = React__namespace.useMemo(() => Boolean(props.value || props.value === 0), [props.value]);
    const inputValue = React__namespace.useMemo(() => (inFocus && (props.value || props.value === 0) ? props.value : ''), [props.value, inFocus]);
    const showArrows = !props.disableArrows && !props.isReadonly && !props.isDisabled;
    const handleWrapperFocus = () => {
        var _a;
        (_a = inputRef.current) === null || _a === void 0 ? void 0 : _a.focus();
    };
    return (React__namespace.createElement("div", Object.assign({ className: uuiCore.cx(css$q.container, uuiCore.uuiElement.inputBox, props.isReadonly && uuiCore.uuiMod.readonly, props.isDisabled && uuiCore.uuiMod.disabled, props.isInvalid && uuiCore.uuiMod.invalid, !props.isReadonly && inFocus && uuiCore.uuiMod.focus, !props.isReadonly && !props.isDisabled && uuiCore.uuiMarkers.clickable, !showArrows && uuiNumericInput.withoutArrows, props.cx), onClick: props.onClick, onFocus: handleWrapperFocus, onKeyDown: handleArrowKeyDown, tabIndex: -1, ref: ref }, props.rawProps),
        React__namespace.createElement("input", { type: "number", className: uuiCore.cx(uuiCore.uuiElement.input, props.inputCx, props.align === 'right' && css$q.alignRight, isPlaceholderColored && uuiCore.uuiElement.valueInPlaceholder), disabled: props.isDisabled, readOnly: props.isReadonly, tabIndex: inFocus || props.isReadonly || props.isDisabled ? -1 : 0, "aria-required": props.isRequired, value: inputValue, inputMode: "numeric", placeholder: placeholderValue, onChange: handleChange, onFocus: handleFocus, onBlur: handleBlur, min: min, max: max, step: step, id: props.id, ref: inputRef }),
        showArrows && (React__namespace.createElement("div", { className: uuiNumericInput.buttonGroup },
            React__namespace.createElement(IconContainer, { cx: uuiNumericInput.upButton, icon: props.upIcon, onClick: handleIncreaseValue, isDisabled: props.isDisabled, rawProps: { role: 'button' } }),
            React__namespace.createElement(IconContainer, { cx: uuiNumericInput.downButton, icon: props.downIcon, onClick: handleDecreaseValue, isDisabled: props.isDisabled, rawProps: { role: 'button' } })))));
});

var css$p = {"container":"LsPlOS","circle":"u5jtvO"};

const RadioInput = /* @__PURE__ */React__namespace.forwardRef((props, ref) => {
    const context = uuiCore.useUuiContext();
    const handleChange = () => {
    ...
    return (React__namespace.createElement("label", Object.assign({ className: uuiCore.cx(css$p.container, props.isDisabled && uuiCore.uuiMod.disabled, props.isReadonly && uuiCore.uuiMod.readonly, props.isInvalid && uuiCore.uuiMod.invalid, props.cx, !props.isReadonly && !props.isDisabled && uuiCore.uuiMarkers.clickable), ref: ref }, props.rawProps),
        React__namespace.createElement("div", { className: uuiCore.cx(uuiCore.uuiElement.radioInput, props.value && uuiCore.uuiMod.checked), onFocus: props.onFocus, onBlur: props.onBlur },
            React__namespace.createElement("input", { name: props.name, type: "radio", onChange: !props.isReadonly ? handleChange : undefined, disabled: props.isDisabled, "aria-disabled": props.isDisabled || undefined, readOnly: props.isReadonly, "aria-readonly": props.isReadonly || undefined, required: props.isRequired, "aria-required": props.isRequired || undefined, checked: props.value || false, "aria-checked": props.value || false, id: props.id, tabIndex: props.tabIndex }),
            props.value && React__namespace.createElement(IconContainer, { icon: props.icon, cx: css$p.circle })),
        (props.renderLabel || props.label) && (React__namespace.createElement("div", { className: uuiCore.uuiElement.inputLabel }, props.renderLabel ? props.renderLabel() : props.label))));
});

var css$o = {"container":"AB3XQk","container--readonly":"KkbH4g","containerReadonly":"KkbH4g"};

class BaseRating extends React__namespace.Component {
    constructor(props) {
        super(props);
...
const maxValue = 5;
class Rating extends React__namespace.Component {
    constructor() {
        super(...arguments);
        ...
        this.getEmptyStars = (rating) => {
            ...
            for (let i = 0; i < maxValue; i++) {
                Tooltip
                    && emptyStars.push(React__namespace.createElement(Tooltip, { key: 'star-' + i, placement: "top", content: this.hidingTooltip(rating), cx: css$n.tooltip },
                        React__namespace.createElement("div", { className: uuiRating.star },
                            React__namespace.createElement(IconContainer, { icon: this.props.emptyStarIcon }))));
            }
            return emptyStars;
        };
        this.getFilledStars = (rating) => {
            ...
            for (let i = 0; i < maxValue; i++) {
                Tooltip
                    && filledStars.push(React__namespace.createElement(Tooltip, { key: i, placement: "top", content: this.hidingTooltip(rating), cx: css$n.tooltip },
                        React__namespace.createElement("div", { className: uuiRating.star },
                            React__namespace.createElement(IconContainer, { icon: this.props.filledStarIcon }))));
            }
            return filledStars;
        };
        this.renderRating = (rating, markWidth) => {
            return (React__namespace.createElement("div", { key: rating, className: css$n.container },
                React__namespace.createElement("div", { key: "e", className: uuiRating.emptyStarContainer }, this.getEmptyStars(rating)),
                React__namespace.createElement("div", { key: "f", className: uuiRating.filledStarContainer, style: { width: this.getFilledStarsWidth(rating, markWidth) } }, this.getFilledStars(rating))));
        };
    }
    render() {
        return React__namespace.createElement(BaseRating, Object.assign({}, this.props, { from: this.props.step || 1, to: maxValue, step: this.props.step, renderRating: this.renderRating }));
    }
}
...
class SliderBase extends React__namespace.Component {
    constructor() {
        super(...arguments);
...
class SliderHandle extends React__namespace.Component {
    constructor() {
        super(...arguments);
        this.state = {
            isHovered: false,
    ...
    renderTooltip() {
        ...
        return React__namespace.createElement("div", { className: uuiCore.uuiElement.tooltipBody }, content);
    }
    render() {
        return (React__namespace.createElement(reactPopper.Manager, null,
            React__namespace.createElement(reactPopper.Reference, null, (targetProps) => (React__namespace.createElement("div", Object.assign({ tabIndex: 0, ref: (handle) => {
                    this.sliderHandle = handle;
                    targetProps.ref(handle);
                }, className: uuiCore.cx(uuiSlider.handle, this.props.cx), style: { transform: `translateX(${this.props.offset || 0}px)` }, onMouseDown: this.handleMouseDown, onMouseUp: this.handleMouseUp, onKeyDown: this.handleKeyDown, onFocus: this.handleFocus, onBlur: this.handleBlur }, this.props.rawProps)))),
            React__namespace.createElement(Portal, null,
                React__namespace.createElement(reactPopper.Popper, { placement: "top", key: this.props.offset }, ({ ref, style, placement }) => {
                    return ((this.props.isActive || this.state.isHovered) && (React__namespace.createElement("div", { ref: ref, style: style, "data-placement": placement, className: uuiCore.cx(this.props.cx, css$l.container, uuiCore.uuiElement.tooltipContainer, css$l.tooltipWrapper) },
                        this.props.showTooltip && this.renderTooltip(),
                        React__namespace.createElement("div", { className: uuiCore.uuiElement.tooltipArrow }))));
                }))));
    }
}

class SliderScaleElement extends React__namespace.Component {
    constructor() {
        super(...arguments);
    ...
    render() {
        ...
        return (React__namespace.createElement(React__namespace.Fragment, null,
            React__namespace.createElement("div", { className: uuiCore.cx(uuiSlider.scaleDot, this.props.isFilledDot && uuiSlider.scaleFilledDot), ref: (scaleDotRef) => (this.scaleDot = scaleDotRef), style: { transform: `translateX(${dotOffset}px)` } }),
            React__namespace.createElement("div", { className: uuiSlider.scaleNumber, ref: (scaleNumberRef) => (this.scaleNumber = scaleNumberRef), style: { transform: `translateX(${numberOffset}px)` } }, this.props.label)));
    }
}

class SliderScaleBase extends React__namespace.Component {
    constructor() {
        super(...arguments);
    ...
    render() {
        return React__namespace.createElement("div", { className: uuiSlider.scale }, this.renderSliderScaleElements());
    }
}
...
class RangeSliderScale extends SliderScaleBase {
    renderSliderScaleElements() {
        ...
        return this.generateScale(splitAt).map((value) => {
            ...
            const sliderMargin = uuiCore.isClientSide && this.props.slider && +window.getComputedStyle(this.props.slider).marginLeft.slice(0, -2);
            return (React__namespace.createElement(SliderScaleElement, { key: value, sliderWidth: sliderWidth, offset: offset, isFilledDot: this.props.handleOffset.from <= offset && offset <= this.props.handleOffset.to, label: value, sliderMargin: sliderMargin }));
        });
    }
}
...
class RangeSlider extends SliderBase {
    ...
    render() {
        ...
        return (React__namespace.createElement("div", Object.assign({ className: uuiCore.cx(uuiSlider.container, css$m.root, this.props.isDisabled && uuiCore.uuiMod.disabled, this.props.cx), onClick: this.handleMouseClick, ref: this.props.forwardedRef }, this.props.rawProps),
            React__namespace.createElement("div", { ref: (slider) => (this.slider = slider), className: uuiCore.cx(uuiSlider.slider, this.state.activeHandle && uuiCore.uuiMod.active) }),
            React__namespace.createElement("div", { className: uuiSlider.filled, style: {
...
class SliderScale extends SliderScaleBase {
    renderSliderScaleElements() {
        ...
        return this.generateScale(splitAt).map((value, index) => {
            const offset = (value - this.props.min) * this.props.valueWidth;
            const sliderMargin = uuiCore.isClientSide && this.props.slider && +window.getComputedStyle(this.props.slider).marginLeft.slice(0, -2);
            return (React__namespace.createElement(SliderScaleElement, { key: index, offset: offset, sliderWidth: sliderWidth, isFilledDot: this.props.handleOffset > offset, label: this.props.renderLabel ? this.props.renderLabel(value) : value, sliderMargin: sliderMargin }));
        });
    }
}
...
class Slider extends SliderBase {
    ...
    render() {
        ...
        return (React__namespace.createElement("div", Object.assign({ className: uuiCore.cx(uuiSlider.container, css$m.root, this.props.isDisabled && uuiCore.uuiMod.disabled, this.props.cx, this.state.isActive && uuiCore.uuiMod.active), onClick: (e) => this.props.onValueChange(this.getValue(e.clientX, valueWidth)), onMouseDown: this.handleMouseDown, ref: this.props.forwardedRef }, this.props.rawProps),
            React__namespace.createElement("div", { ref: (slider) => (this.slider = slider), className: uuiCore.cx(uuiSlider.slider) }),
            React__namespace.createElement("div", { className: uuiSlider.filled, style: { width: filledOffset } }),
            React__namespace.createElement(SliderScale, { handleOffset: filledOffset, slider: this.slider, min: this.props.min, max: this.props.max, splitAt: this.props.splitAt, valueWidth: valueWidth, renderLabel: this.props.renderLabel }),
...
const Switch = /* @__PURE__ */React__namespace.forwardRef((props, ref) => {
    const context = uuiCore.useUuiContext();
    const toggle = () => {
        props.onValueChange(!props.value);
        if (props.getValueChangeAnalyticsEvent) {
    ...
    return (React__namespace.createElement("label", Object.assign({ className: uuiCore.cx('uui-switch', css$k.container, props.cx, props.isDisabled && uuiCore.uuiMod.disabled, props.isReadonly && uuiCore.uuiMod.readonly, !props.isReadonly && !props.isDisabled && uuiCore.uuiMarkers.clickable), ref: ref }, props.rawProps),
        React__namespace.createElement("div", { className: uuiCore.cx(uuiCore.uuiElement.switchBody, props.value && uuiCore.uuiMod.checked), onFocus: props.onFocus, onBlur: props.onBlur },
            React__namespace.createElement("input", { type: "checkbox", role: "switch", onChange: !props.isReadonly ? toggle : undefined, readOnly: props.isReadonly, "aria-readonly": props.isReadonly || undefined, disabled: props.isDisabled, "aria-disabled": props.isDisabled, checked: props.value || false, "aria-checked": props.value || false, required: props.isRequired, tabIndex: props.tabIndex, id: props.id }),
            React__namespace.createElement("div", { className: uuiCore.uuiElement.switchToggler })),
        props.label && React__namespace.createElement("div", { className: uuiCore.uuiElement.inputLabel }, props.label)));
});

var css$j = {"container":"WJPuoS","auto-size":"eVzSx2","no-auto-size":"Qba4HL","autoSize":"eVzSx2","noAutoSize":"Qba4HL"};

const TextArea = /* @__PURE__ */React__namespace.forwardRef((props, ref) => {
    var _a;
    const [state, setState] = React.useState({
        inFocus: false,
    });
    ...
    return (React__namespace.createElement("div", Object.assign({ className: uuiCore.cx(css$j.container, uuiCore.uuiElement.inputBox, props.cx) }, props.rawProps, { tabIndex: -1, onFocus: handleWrapperFocus, ref: ref }),
        React__namespace.createElement("textarea", { autoFocus: props.autoFocus, placeholder: props.placeholder, className: uuiCore.cx(!props.isDisabled && uuiCore.uuiMarkers.clickable, props.autoSize || props.isDisabled || props.isReadonly ? css$j.autoSize : css$j.noAutoSize, uuiCore.uuiElement.input, !props.isReadonly && state.inFocus && uuiCore.uuiMod.focus, props.isDisabled && uuiCore.uuiMod.disabled, props.isReadonly && uuiCore.uuiMod.readonly, props.isInvalid && uuiCore.uuiMod.invalid, props.inputCx), rows: props.rows != null ? props.rows : props.autoSize ? 1 : undefined, id: props.id, readOnly: props.isReadonly, "aria-readonly": props.isReadonly, required: props.isRequired, disabled: props.isDisabled, "aria-disabled": props.isDisabled, onChange: handleChange, value: props.value || '', maxLength: props.maxLength, onFocus: handleFocus, onBlur: handleBlur, ref: textAreaRef, onKeyDown: props.onKeyDown, tabIndex: (state.inFocus || props.isReadonly || props.isDisabled) ? -1 : 0, dir: (_a = props.rawProps) === null || _a === void 0 ? void 0 : _a.dir })));
});
...
const ENTER = 'Enter';
const ESCAPE = 'Escape';
const TextInput = /* @__PURE__ */React__namespace.forwardRef((props, ref) => {
    const context = uuiCore.useUuiContext();
    const [inFocus, setInFocus] = React__namespace.useState(false);
    const inputElement = React__namespace.useRef();
    const handleChange = (e) => {
        // Android does not support maxLength
        // https://studysection.com/blog/the-html-maxlength-attribute-is-not-working-as-expected-on-android-phones/
        const targetValue = e.target.value;
    ...
    const handleClick = (e) => {
        var _a;
        if (e.target.classList.contains(uuiCore.uuiMarkers.clickable)) {
    ...
    const getInputProps = () => {
        ...
        return ({
            ...
            className: uuiCore.cx(uuiCore.uuiElement.input, props.inputCx),
    ...
    const icon = props.icon && React__namespace.createElement(IconContainer, { icon: props.icon, onClick: props.onIconClick });
    const showIconsOnAction = props.value && !props.isReadonly && !props.isDisabled;
    return (React__namespace.createElement("div", Object.assign({ onClick: props.onClick && handleClick, ref: ref, className: uuiCore.cx(css$i.container, uuiCore.uuiElement.inputBox, props.isDisabled && uuiCore.uuiMod.disabled, props.isReadonly && uuiCore.uuiMod.readonly, props.isInvalid && uuiCore.uuiMod.invalid, !props.isReadonly && !props.isDisabled && uuiCore.uuiMarkers.clickable, !props.isReadonly && inFocus && uuiCore.uuiMod.focus, props.cx), tabIndex: -1, onFocus: handleWrapperFocus }, props.rawProps),
        props.iconPosition !== 'right' && icon,
        props.renderInput ? props.renderInput(getInputProps()) : React__namespace.createElement("input", Object.assign({}, getInputProps())),
        props.onAccept && showIconsOnAction && (React__namespace.createElement(IconContainer, { cx: uuiCore.cx('uui-icon-accept'), isDisabled: props.isDisabled, icon: props.acceptIcon, onClick: props.onAccept, rawProps: { role: 'button' } })),
        props.onCancel && showIconsOnAction && (React__namespace.createElement(IconContainer, { cx: uuiCore.cx('uui-icon-cancel', uuiCore.uuiMarkers.clickable), isDisabled: props.isDisabled, icon: props.cancelIcon, onClick: handleCancel, rawProps: { role: 'button' } })),
        props.iconPosition === 'right' && icon,
        props.isDropdown && (React__namespace.createElement(IconContainer, { cx: uuiCore.cx((props.isReadonly || props.isDisabled) && css$i.hidden, css$i.pointer), icon: props.dropdownIcon, flipY: props.isOpen }))));
});

var css$h = {"prefixWrapper":"q7XNRp"};

function InputAddon(props) {
    return (React__namespace.default.createElement("div", { className: uuiCore.cx(css$h.prefixWrapper, props.cx, 'uui-input-addon') }, props.content));
}

var css$g = {"avatar":"bld93l"};

function AvatarComponent(props, ref) {
    const [isError, setIsError] = React__namespace.default.useState(false);
    function onError() {
        if (!isError) {
            setIsError(true);
        }
    }
    return (React__namespace.default.createElement("img", Object.assign({ ref: ref, className: uuiCore.cx(css$g.avatar, props.cx), width: props.size, height: props.size, src: props.isLoading || !props.img || isError
...
const Avatar = /* @__PURE__ */React__namespace.default.forwardRef(AvatarComponent);

var css$f = {"avatar-right":"dbKG-V","avatar-left":"HsID5q","container":"FnFbDF","avatarRight":"dbKG-V","avatarLeft":"HsID5q"};

const AvatarStack = /* @__PURE__ */React__namespace.forwardRef((props, ref) => {
    ...
    return (React__namespace.createElement(FlexRow, { cx: props.cx, ref: ref, rawProps: props.rawProps },
        React__namespace.createElement(FlexRow, { rawProps: { role: 'group', style: styleObj }, cx: cx__default.default('avatars', css$f.container, css$f['avatar-' + direction]) }, firstElements.map((avatar, index) => {
            return renderItem ? (React__namespace.createElement(React__namespace.Fragment, { key: index }, renderItem(avatar))) : (React__namespace.createElement(Avatar, { key: index, size: avatarSize, img: avatar, alt: "avatar" }));
        })),
        React__namespace.createElement("div", { className: "avatarsCount" }, avatarsCount && urlArray.length > avatarsCount ? '+' + (urlArray.length - avatarsCount) : null)));
});
...
class Spinner extends React__namespace.Component {
    render() {
        const dots = [];
        for (let i = 0; i < QUANTITY_OF_DOTS; i += 1) {
            dots.push(React__namespace.createElement("div", { key: i, className: uuiCore.cx(uuiSpinner.dot, uuiSpinner['dot' + (i + 1)]) }));
        }
        return (React__namespace.createElement("div", Object.assign({ className: uuiCore.cx(css$e.container, uuiSpinner.container, this.props.cx), ref: this.props.forwardedRef }, this.props.rawProps),
            React__namespace.createElement("div", { className: uuiSpinner.animation }, dots)));
    }
}

const FIRST_PAGE = 1;
const SIMPLE_PAGINATION_ITEMS = 7;
class Paginator extends React__namespace.Component {
    constructor() {
        super(...arguments);
    ...
    getPagesView() {
        ...
        if (pages <= SIMPLE_PAGINATION_ITEMS) {
            uuiCore.range(1, pages + 1).forEach((pageNumber) => {
                addPage(pageNumber);
            });
        }
        ...
        if (pages > SIMPLE_PAGINATION_ITEMS) {
            ...
            if (currentPage < 5) {
                uuiCore.range(1, 6).forEach((pageNumber) => addPage(pageNumber));
                addSpacer();
                addPage(pages);
            }
            ...
            if (currentPage > pages - 4) {
                addPage(1);
                addSpacer();
                uuiCore.range(pages - 4, pages + 1).forEach((pageNumber) => addPage(pageNumber));
            }
            ...
            if (currentPage > 4 && currentPage < pages - 3) {
                addPage(1);
                addSpacer();
                uuiCore.range(currentPage - 1, currentPage + 2).forEach((pageNumber) => addPage(pageNumber));
                addSpacer();
                addPage(pages);
            }
        }
...
Paginator.contextType = uuiCore.UuiContext;

var css$d = {"file-input":"_6Rfqe-","fileInput":"_6Rfqe-"};

class UploadFileToggler extends React__namespace.Component {
    constructor() {
        super(...arguments);
        this.fileInput = React__namespace.createRef();
        this.onClick = () => {
            var _a;
    ...
    render() {
        return (React__namespace.createElement("div", Object.assign({ ref: this.props.forwardedRef }, this.props.rawProps),
            React__namespace.createElement("input", { className: css$d.fileInput, ref: this.fileInput, onChange: (e) => {
...
const ProgressBar = /* @__PURE__ */React__namespace.forwardRef((props, ref) => {
    const { hideLabel = false, progress, label } = props;
    const barLabel = label || `${props.progress || 0}%`;
    return (React__namespace.createElement("div", Object.assign({ ref: ref, className: cx__default.default('uui-progress_bar', props.cx, css$c.container) }, props.rawProps),
        React__namespace.createElement("div", { role: "progressbar", className: cx__default.default(css$c.bar, 'bar'), style: { width: `${props.progress || 0}%` }, "aria-valuenow": progress, "aria-valuemin": 0, "aria-valuemax": 100 }),
        !hideLabel && (React__namespace.createElement(React__namespace.Fragment, null,
            React__namespace.createElement("div", { className: cx__default.default(css$c.label, 'label') }, barLabel),
            React__namespace.createElement("div", { className: cx__default.default(css$c.label, 'topLabel'), style: { clipPath: `inset(0 0 0 ${props.progress}%)` } }, barLabel)))));
});

const Clickable = /* @__PURE__ */React__namespace.default.forwardRef((props, ref) => {
    var _a;
    const context = uuiCore.useUuiContext();
    ...
    const clickHandler = (e) => {
        if (!uuiCore.isEventTargetInsideClickable(e) && !props.isDisabled) {
            if (props.onClick) {
                props.onClick(e);
            }
            if (!!props.link) {
    ...
    const className = uuiCore.cx({
        [uuiCore.uuiElement.buttonBox]: true,
        [uuiCore.uuiMod.enabled]: !props.isDisabled,
        [uuiCore.uuiMod.disabled]: props.isDisabled,
        [uuiCore.uuiMod.active]: getIsLinkActive(),
        [uuiCore.uuiMarkers.clickable]: isAnchor || hasClick,
        [uuiCore.uuiElement.anchor]: isAnchor,
    }, props.cx);
    const commonProps = {
        className,
    ...
    if (isAnchor) {
        ...
        return (React__namespace.default.createElement("a", Object.assign({ href: href, target: target, ref: ref }, relProp, commonProps, props.rawProps), props.children));
    }
    if (isButton) {
        return (React__namespace.default.createElement("button", Object.assign({ ref: ref, type: ((_a = props.rawProps) === null || _a === void 0 ? void 0 : _a.type) || 'button' }, commonProps, props.rawProps), props.children));
    }
    return (React__namespace.default.createElement("span", Object.assign({ ref: ref }, commonProps, props.rawProps), props.children));
});

var css$b = {"container":"hu-Zps"};

const Button = /* @__PURE__ */React__namespace.forwardRef((props, ref) => {
    return (React__namespace.createElement(Clickable, Object.assign({}, props, { rawProps: Object.assign({ 'aria-haspopup': props.isDropdown, 'aria-expanded': props.isOpen }, props.rawProps), cx: [css$b.container, props.cx], type: "button", ref: ref }),
        props.icon && props.iconPosition !== 'right' && (React__namespace.createElement(IconContainer, { icon: props.icon, onClick: !props.isDisabled ? props.onIconClick : undefined })),
        props.caption && (React__namespace.createElement("div", { className: uuiCore.uuiElement.caption }, props.caption)),
        props.icon && props.iconPosition === 'right' && (React__namespace.createElement(IconContainer, { icon: props.icon, onClick: !props.isDisabled ? props.onIconClick : undefined })),
        props.isDropdown && (React__namespace.createElement(IconContainer, { icon: props.dropdownIcon, flipY: props.isOpen })),
        props.onClear && !props.isDisabled && (React__namespace.createElement(IconContainer, { cx: uuiCore.uuiMarkers.clickable, icon: props.clearIcon, onClick: props.onClear }))));
});

var css$a = {"container":"g5xIoC"};

const IconButton = /* @__PURE__ */React__namespace.forwardRef((props, ref) => {
    return (React__namespace.createElement(Clickable, Object.assign({}, props, { type: "button", cx: [css$a.container, props.cx], ref: ref }),
        React__namespace.createElement(IconContainer, { icon: props.icon, size: props.size }),
        props.showDropdownIcon && (React__namespace.createElement(IconContainer, { icon: props.dropdownIcon, flipY: props.isOpen, size: props.size }))));
});

var css$9 = {"container":"buM1o1"};

const Anchor = /* @__PURE__ */React__namespace.default.forwardRef((props, ref) => {
    return (React__namespace.default.createElement(Clickable, Object.assign({}, props, { type: "anchor", cx: [css$9.container, props.cx], ref: ref })));
});
...
class Burger extends React__namespace.Component {
    constructor(props) {
        super(props);
        this.state = {
            isOpen: false,
        ...
        this.renderContent = (ref) => {
            ...
            return (React__namespace.createElement("div", { ref: ref, className: cx__default.default(this.props.cx, this.props.burgerContentCx, uuiBurger.overlay, uuiBurger.overlayVisible, css$8.containerContent), onClick: handleOnClick },
                React__namespace.createElement(FocusLock__default.default, { returnFocus: true, className: cx__default.default(this.props.cx, uuiBurger.items, uuiBurger.itemsVisible), lockProps: { onKeyDown: handleKeyDown } }, this.props.renderBurgerContent ? this.props.renderBurgerContent({ onClose: this.toggleBurgerMenu }) : undefined)));
        };
    }
    componentWillUnmount() {
    ...
    render() {
        return (React__namespace.createElement(React__namespace.Fragment, null,
            React__namespace.createElement("div", Object.assign({ ref: this.props.forwardedRef, className: cx__default.default(this.props.cx, uuiBurger.menu, css$8.container, this.state.isOpen && uuiBurger.menuOpen) }, this.props.rawProps),
                React__namespace.createElement("button", { className: uuiBurger.button, onClick: this.toggleBurgerMenu },
                    React__namespace.createElement(IconContainer, { icon: this.state.isOpen ? this.props.crossIcon : this.props.burgerIcon }))),
            React__namespace.createElement(PortalWithCssTransition, { timeout: uuiBurgerTransitionTimeout, cssTransitionClasses: uuiBurgerTransitionClasses, isOpen: this.state.isOpen, renderContent: this.renderContent })));
    }
}
/**
...
function PortalWithCssTransition(props) {
    ...
    const renderContentLocal = React.useCallback((ref) => {
        return React__namespace.createElement(Portal, Object.assign({}, portalProps), props.renderContent(ref));
    }, [props.renderContent]);
    return (React__namespace.createElement(reactTransitionGroup.CSSTransition, { nodeRef: nodeRef, in: isOpen, timeout: timeout, mountOnEnter: true, unmountOnExit: true, classNames: cssTransitionClasses }, renderContentLocal(nodeRef)));
}

var css$7 = {"container":"CxmWda","logo":"y1K7zH","arrow":"kQRY5N"};

class MainMenuLogo extends React__namespace.Component {
    render() {
        return (React__namespace.createElement("div", Object.assign({ onContextMenu: this.props.onContextMenu, onClick: this.props.onClick, ref: this.props.forwardedRef }, this.props.rawProps),
            React__namespace.createElement(Anchor, { cx: css$7.container, link: this.props.link, href: this.props.href, target: this.props.target, isDisabled: !this.props.href && !this.props.link },
                React__namespace.createElement("img", { className: css$7.logo, alt: "Main Menu Logo", src: this.props.logoUrl ? this.props.logoUrl : undefined, style: { backgroundColor: this.props.logoBgColor } }),
                this.props.showArrow && React__namespace.createElement("div", { className: uuiCore.cx(css$7.logo, css$7.arrow), style: { borderLeftColor: this.props.logoBgColor } }))));
    }
}
...
class MainMenu extends React__namespace.default.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    convertReactChildrenToItems(children) {
        ...
        const items = React__namespace.default.Children.map(children, (child, index) => {
            if (child) {
                ...
                return {
                    ...
                    render: (item, hiddenItems) => {
                        if (child.props.collapsedContainer) {
                            return React__namespace.default.cloneElement(child, { children: hiddenItems === null || hiddenItems === void 0 ? void 0 : hiddenItems.map((i) => i.render(item, hiddenItems)) });
                        }
                        return child;
                    },
        ...
        if (lastItemsIndexWithCollapseToMore) {
            items.splice(lastItemsIndexWithCollapseToMore, 0, {
                ...
                render: (item, hiddenItems) => (React__namespace.default.createElement(MainMenuDropdown, { key: "moreDropdown", caption: i18n.mainMenu.moreButtonCaption, children: hiddenItems === null || hiddenItems === void 0 ? void 0 : hiddenItems.filter((i) => i.props.collapseToMore).map((i) => i.render(item, hiddenItems)) })),
    ...
    renderServerBadge() {
        ...
        return this.props.serverBadge !== 'Prod' && this.props.serverBadge !== 'Public' && this.props.serverBadge !== 'Demo' ? (React__namespace.default.createElement("div", { className: uuiCore.cx(uuiMainMenu.serverBadge) },
            React__namespace.default.createElement("div", { className: uuiCore.cx(uuiMainMenu.serverBadgeLabel), style: { background: serverBadgeColor } }, this.props.serverBadge))) : null;
    }
    getMenuItems() {
        ...
        if (this.props.appLogoUrl) {
            items.unshift({
                id: 'appLogo',
                priority: 100500,
                render: () => (React__namespace.default.createElement(MainMenuLogo, { key: "logo", logoUrl: this.props.appLogoUrl, link: this.props.logoLink, href: this.props.logoHref, onClick: this.props.onLogoClick })),
            });
        }
        if (this.props.customerLogoUrl) {
            items.unshift({
                id: 'customerLogo',
                priority: 100499,
                render: () => (React__namespace.default.createElement(MainMenuLogo, { key: "customerLogo", logoUrl: this.props.customerLogoUrl, logoBgColor: this.props.customerLogoBgColor, link: this.props.customerLogoLink || this.props.logoLink, href: this.props.customerLogoHref || this.props.logoHref, showArrow: true })),
            });
        }
        items.unshift({
            id: 'Burger',
            ...
            render: () => (React__namespace.default.createElement(Burger, { key: "burger", width: 300, renderBurgerContent: this.props.renderBurger, logoUrl: this.props.customerLogoUrl || this.props.appLogoUrl, bg: this.props.customerLogoBgColor || undefined })),
        });
        return items;
    }
    render() {
        return (React__namespace.default.createElement("nav", Object.assign({ key: "uuiMainMenu", className: uuiCore.cx(this.props.cx, uuiMainMenu.container, css$6.container, this.props.isTransparent && uuiMainMenu.transparent) }, this.props.rawProps),
            React__namespace.default.createElement(AdaptivePanel, { items: this.props.items || this.getMenuItems(), cx: css$6.itemsContainer }),
            this.renderServerBadge()));
    }
}

class MainMenuCustomElement extends React__namespace.Component {
    render() {
...
function useScrollSpy(props) {
    ...
    const [observedNodes, setObservedNodes] = React.useState([]);
    const [currentActive, setCurrentActive] = React.useState(props.initialActive || (Array.isArray(props.elements) && props.elements.length > 0 && props.elements[0]));
    const setRef = React.useCallback((selectedRef) => (ref.current = selectedRef), [ref]);
    const getElement = React.useCallback((id) => {
        var _a;
        return (_a = ref.current) === null || _a === void 0 ? void 0 : _a.querySelector(`[data-spy=${id}]`);
    }, [ref]);
    const scrollToElement = React.useCallback((item) => {
        var _a;
...
const DataTableRowContainer = /* @__PURE__ */React__namespace.default.forwardRef((props, ref) => {
    var _a;
    ...
    function wrapFixedSection(columns, direction, hasScrollingSection) {
        return (React__namespace.default.createElement("div", { style: getSectionStyle(columns), className: uuiCore.cx({
                [css$5.section]: true,
            ...
            renderCells(columns),
            hasScrollingSection && direction === 'right' && React__namespace.default.createElement("div", { className: uuiDataTableRowCssMarkers.uuiScrollShadowLeft }),
            hasScrollingSection && direction === 'left' && React__namespace.default.createElement("div", { className: uuiDataTableRowCssMarkers.uuiScrollShadowRight }),
            direction === 'right' && props.renderConfigButton && props.renderConfigButton()));
    }
    function wrapScrollingSection(columns) {
        return (React__namespace.default.createElement("div", { className: uuiCore.cx(css$5.section, css$5.scrollingSection, uuiDataTableRowCssMarkers.uuiTableScrollingSection), style: getSectionStyle(columns, 1) }, renderCells(columns)));
    }
    ...
    return props.link ? (React__namespace.default.createElement(Anchor, { link: props.link, cx: [
            css$5.container, uuiDataTableRowCssMarkers.uuiTableRowContainer, props.onClick && uuiCore.uuiMarkers.clickable, props.cx,
        ], rawProps: rawProps }, getRowContent())) : (React__namespace.default.createElement(FlexRow, { onClick: props.onClick, cx: [
            css$5.container, uuiDataTableRowCssMarkers.uuiTableRowContainer, props.onClick && uuiCore.uuiMarkers.clickable, props.cx,
...
function compareProps(props, nextProps) {
    const isDeepEqual = isEqual__default.default(props, nextProps);
...
const DataTableRowImpl = /* @__PURE__ */React__namespace.default.forwardRef(function DataTableRow(props, ref) {
    const rowLens = uuiCore.Lens.onEditable(props);
    ...
    const renderRow = (params, clickHandler, overlays) => {
        return (React__namespace.default.createElement(DataTableRowContainer, { columns: props.columns, ref: params.ref || ref, renderCell: renderCell, onClick: clickHandler && (() => clickHandler(props)), rawProps: Object.assign(Object.assign(Object.assign(Object.assign({}, props.rawProps), params.eventHandlers), { role: 'row', 'aria-expanded': (props.isFolded === undefined || props.isFolded === null) ? undefined : !props.isFolded }), (props.isSelectable && { 'aria-selected': props.isSelected })), cx: [
                params.classNames,
                props.isSelected && uuiCore.uuiMod.selected,
                params.isDraggable && uuiCore.uuiMarkers.draggable,
                props.isInvalid && uuiCore.uuiMod.invalid,
                uuiDataTableRow.uuiTableRow,
                props.cx,
                props.isFocused && uuiCore.uuiMod.focus,
    ...
    if (props.dnd && (props.dnd.srcData || props.dnd.canAcceptDrop)) {
        return React__namespace.default.createElement(uuiCore.DndActor, Object.assign({}, props.dnd, { render: (params) => { var _a; return renderRow(params, clickHandler, (_a = props.renderDropMarkers) === null || _a === void 0 ? void 0 : _a.call(props, params)); } }));
    }
    else {
        return renderRow({}, clickHandler);
    }
});
const DataTableRow = /* @__PURE__ */React__namespace.default.memo(DataTableRowImpl, compareProps);
...
class DataTableHeaderRow extends React__namespace.default.Component {
    constructor() {
        super(...arguments);
        ...
        this.onCellDrop = (params, index) => {
            ...
            if (params.position === 'left') {
                const newOrder = uuiCore.getOrderBetween(prevColumnOrder, dstColumnConfig.order);
                columnsConfig[params.srcData.key] = Object.assign(Object.assign({}, srcColumnConfig), { order: newOrder });
            }
            else if (params.position === 'right') {
                const newOrder = uuiCore.getOrderBetween(dstColumnConfig.order, nextColumnOrder);
                columnsConfig[params.srcData.key] = Object.assign(Object.assign({}, srcColumnConfig), { order: newOrder });
            }
    ...
    render() {
        return (React__namespace.default.createElement(DataTableRowContainer, { cx: [
...
function getNewColumnOrder(props) {
    ...
    return position === 'bottom' ? uuiCore.getOrderBetween(targetOrder, targetNextOrder || null) : uuiCore.getOrderBetween(targetPrevOrder || null, targetOrder);
}
...
function sortColumnsAndAddGroupKey(props) {
    ...
    const sorted = uuiCore.orderBy(columns, (i) => prevConfig[i.key].order);
    return sorted.map((c) => {
...
function useColumnsConfiguration(props) {
    ...
    const [columnsConfig, setColumnsConfig] = React.useState(() => initialColumnsConfig || defaultConfig);
    const columnsSorted = React.useMemo(() => sortColumnsAndAddGroupKey({ columns, prevConfig: columnsConfig }), [columns, columnsConfig]);
    const toggleVisibility = React.useCallback((columnKey) => setColumnsConfig((prevConfig) => toggleSingleColumnVisibility({ prevConfig, columnsSorted, columnKey })), [columnsSorted]);
    const togglePin = React.useCallback((columnKey, fix) => setColumnsConfig((prevConfig) => toggleSingleColumnPin({ prevConfig, columnsSorted, columnKey, fix })), [columnsSorted]);
    const reset = React.useCallback(() => {
        setColumnsConfig(defaultConfig);
        setSearchValue('');
    }, [defaultConfig]);
    const checkAll = React.useCallback(() => setColumnsConfig((prevConfig) => toggleAllColumnsVisibility({ prevConfig, columns: columnsSorted, value: true })), [columnsSorted]);
    const uncheckAll = React.useCallback(() => setColumnsConfig((prevConfig) => toggleAllColumnsVisibility({ prevConfig, columns: columnsSorted, value: false })), [columnsSorted]);
    const sortedColumnsExtended = React.useMemo(() => columnsSorted.map((column, index) => {
    ...
    const groupedColumns = React.useMemo(() => groupAndFilterSortedColumns({
    ...
    const hasAnySelectedColumns = React.useMemo(() => !!columnsSorted.filter((c) => {
...
class DataTableHeaderCell extends React__namespace.Component {
    constructor() {
        ...
        this.cellRef = React__namespace.createRef();
        this.toggleSort = (e) => {
            if (uuiCore.isEventTargetInsideClickable(e) || !this.props.column.isSortable)
                return;
            let dir;
    ...
    render() {
        ...
        if (this.props.allowColumnsReordering) {
            return (React__namespace.createElement(uuiCore.DndActor, { key: this.props.column.key + (((_b = (_a = this.props.value.columnsConfig) === null || _a === void 0 ? void 0 : _a[this.props.column.key]) === null || _b === void 0 ? void 0 : _b.order) || ''), dstData: this.props.column, srcData: this.props.column.fix ? null : this.props.column, canAcceptDrop: this.canAcceptDrop, onDrop: this.props.onDrop, render: this.renderCellContent }));
        }
        else
...
const DataTableSelectionContext = /* @__PURE__ */React.createContext({
    selectionRange: null,
...
const useSelectionManager = ({ rows, columns }) => {
    ...
    const startCell = React.useMemo(() => getStartCell(selectionRange, rows, columns), [
    ...
    const canBeSelected = React.useCallback((rowIndex, columnIndex, { copyFrom, copyTo }) => {
        var _a, _b, _c, _d;
    ...
    const shouldSelectCell = React.useCallback((rowIndex, columnIndex) => {
    ...
    const getCellSelectionInfo = React.useCallback((rowIndex, columnIndex) => {
...
function DataTableSelectionProvider({ onCopy, rows, columns, children, }) {
    ...
    const value = React.useMemo(() => ({ selectionRange, setSelectionRange, getCellSelectionInfo }), [selectionRange, getCellSelectionInfo]);
    return React__namespace.default.createElement(DataTableSelectionContext.Provider, { value: value }, children);
}
...
function DataTableCellOverlay(props) {
    ...
    const { selectionRange, setSelectionRange, getCellSelectionInfo } = React.useContext(DataTableSelectionContext);
    ...
    const handleCopyingMarkerPointerDown = React.useCallback((e) => {
        e.preventDefault();
        e.stopPropagation();
        uuiCore.blurFocusedElement();
        setSelectionRange({
    ...
    const borderClassNames = isSelected
        && uuiCore.cx(uuiDataTableCellOverlayMarkers.uuiTableCellSelected, showTopBorder && uuiDataTableCellOverlayMarkers.uuiTableCellSelectedTop, showRightBorder && uuiDataTableCellOverlayMarkers.uuiTableCellSelectedRight, showBottomBorder && uuiDataTableCellOverlayMarkers.uuiTableCellSelectedBottom, showLeftBorder && uuiDataTableCellOverlayMarkers.uuiTableCellSelectedLeft);
    ...
    const overlay = (React__namespace.default.createElement("div", { onPointerEnter: handlePointerEnter, className: uuiCore.cx(uuiDataTableCellOverlayMarkers.uuiTableCellOverlay, selectionRange && uuiDataTableCellOverlayMarkers.uuiTableCellSelectionInProgress, props.cx, css$2.root, css$2.overlay, borderClassNames, props.inFocus && uuiCore.uuiMod.focus, props.isInvalid && uuiCore.uuiMod.invalid, props.isReadonly && uuiCore.uuiMod.readonly) }, showMarker && (React__namespace.default.createElement("div", { className: uuiCore.cx(css$2.copyingMarker, showMarkerHover ? uuiDataTableCellOverlayMarkers.uuiCopyingMarkerHover : uuiDataTableCellOverlayMarkers.uuiCopyingMarker), onPointerDown: handleCopyingMarkerPointerDown, onClick: (e) => e.stopPropagation() }))));
...
const DataTableFocusContext = /* @__PURE__ */React.createContext({
    dataTableFocusManager: null,
});

function DataTableFocusProvider({ dataTableFocusManager, children }) {
    const value = React.useMemo(() => ({ dataTableFocusManager }), [dataTableFocusManager]);
    if (!value.dataTableFocusManager) {
        // eslint-disable-next-line react/jsx-no-useless-fragment
        return (React__namespace.default.createElement(React__namespace.default.Fragment, null, children));
    }
    return (React__namespace.default.createElement(DataTableFocusContext.Provider, { value: value }, children));
}
...
function useShortcuts({ enableShortcuts = true, shortcuts }, deps) {
    const shortcutsManager = React.useMemo(() => {
        if (!enableShortcuts)
            return null;
...
function useDataTableFocusManager({ enableMovementShortcuts = true } = {}, deps) {
    const focusManager = React.useMemo(() => new DataTableFocusManager(), [...deps, enableMovementShortcuts]);
...
const DataTableCellContainer = /* @__PURE__ */React__namespace.forwardRef((props, ref) => {
    return (React__namespace.createElement(FlexCell, Object.assign({}, props.column, { minWidth: props.column.width, rawProps: props.rawProps, cx: ['uui-dt-vars', css$1.cell, props.column.cx, props.cx], onClick: props.onClick, textAlign: props.textAlign, alignSelf: props.alignSelf, shrink: props.shrink, ref: ref, style: props.style }), props.children));
});
...
function DataTableCell(props) {
    ...
    const [state, setState] = React__namespace.default.useState({ inFocus: false });
    const row = props.rowProps;
    const ref = React__namespace.default.useRef();
    const editorRef = React__namespace.default.useRef();
    const isEditable = !!props.onValueChange;
    const isReadonly = (_a = props.isReadonly) !== null && _a !== void 0 ? _a : props.rowProps.isReadonly;
    const tableFocusContext = React.useContext(DataTableFocusContext);
    React.useEffect(() => {
        var _a;
        if (isEditable) {
    ...
    let content;
    const handleEditableCellClick = React__namespace.default.useCallback((e) => {
        var _a;
    ...
    if (props.rowProps.isLoading) {
        ...
        content = (React__namespace.default.createElement("div", { className: css$3.editorWrapper, onClick: handleEditableCellClick },
            props.renderEditor(editorProps),
            React__namespace.default.createElement(DataTableCellOverlay, { renderTooltip: props.renderTooltip, inFocus: state.inFocus, rowIndex: row.index, columnIndex: props.index, isInvalid: (_f = props.isInvalid) !== null && _f !== void 0 ? _f : props.rowProps.isInvalid, isReadonly: isReadonly, validationMessage: (_g = props.validationMessage) !== null && _g !== void 0 ? _g : props.rowProps.validationMessage })));
    }
    else {
    ...
    const getWrappedContent = () => (React__namespace.default.createElement("div", { style: styles, className: css$3.contentWrapper }, content));
    return (React__namespace.default.createElement(DataTableCellContainer, { ref: ref, column: props.column, textAlign: props.isFirstColumn ? undefined : props.column.textAlign, alignSelf: props.isFirstColumn ? undefined : props.column.alignSelf, rawProps: { role: 'cell' }, cx: [
            uuiDataTableCellMarkers.uuiTableCell, css$3.cell, props.cx, props.isInvalid && uuiCore.uuiMod.invalid, state.inFocus && uuiCore.uuiMod.focus,
...
class PickerBodyBase extends React__namespace.Component {
    constructor() {
        super(...arguments);
        this.needFocusSearch = this.showSearch();
        this.searchRef = React__namespace.createRef();
    ...
    componentDidUpdate(prevProps) {
        ...
        if (this.needFocusSearch && !uuiCore.isMobile()) {
            (_a = this.searchRef.current) === null || _a === void 0 ? void 0 : _a.focus({ preventScroll: true });
            this.needFocusSearch = false;
        }
        if (prevProps.rows.length !== this.props.rows.length || (!isEqual__default.default(prevProps.value.checked, this.props.value.checked) && !this.props.fixedBodyPosition)) {
...
function PickerTogglerComponent(props, ref) {
    const [inFocus, setInFocus] = React__namespace.useState(false);
    const toggleContainer = React__namespace.useRef();
    const inputContainer = React__namespace.useRef();
    React__namespace.useImperativeHandle(ref, () => toggleContainer.current, [toggleContainer.current]);
    ...
    const renderInput = () => {
        ...
        return (React__namespace.createElement("input", { id: props === null || props === void 0 ? void 0 : props.id, type: "text", tabIndex: -1, ref: inputContainer, "aria-haspopup": true, autoComplete: "no", "aria-required": props.isRequired, "aria-disabled": props.isDisabled, "aria-readonly": props.isReadonly, className: uuiCore.cx(uuiCore.uuiElement.input, props.pickerMode === 'single' && css.singleInput, props.searchPosition === 'input' && css.cursorText, isActivePlaceholder() && uuiCore.uuiElement.placeholder), disabled: props.isDisabled, placeholder: placeholder, value: value || '', readOnly: props.isReadonly || props.disableSearch, onChange: (e) => { var _a; return (_a = props.onValueChange) === null || _a === void 0 ? void 0 : _a.call(props, e.target.value); }, dir: "auto" }));
    };
    const shouldToggleBody = (e) => {
        const isInteractionDisabled = (props.isDisabled || props.isReadonly || uuiCore.isEventTargetInsideClickable(e));
    ...
    const icon = props.icon && (React__namespace.createElement(IconContainer, { icon: props.icon, onClick: props.onIconClick }));
    return (React__namespace.createElement("div", Object.assign({ onClick: togglerPickerOpened, ref: toggleContainer, className: uuiCore.cx(css.container, uuiCore.uuiElement.inputBox, props.isDisabled && uuiCore.uuiMod.disabled, props.isReadonly && uuiCore.uuiMod.readonly, props.isInvalid && uuiCore.uuiMod.invalid, !props.isReadonly && !props.isDisabled && props.onClick && uuiCore.uuiMarkers.clickable, !props.isReadonly && !props.isDisabled && inFocus && uuiCore.uuiMod.focus, props.cx), tabIndex: inFocus || props.isReadonly || props.isDisabled ? -1 : 0, onFocus: handleFocus, onBlur: handleBlur, onKeyDown: props.onKeyDown }, props.rawProps),
        React__namespace.createElement("div", { className: uuiCore.cx(css.body, !props.isSingleLine && props.pickerMode !== 'single' && 'uui-picker_toggler-multiline') },
            props.iconPosition !== 'right' && icon,
            props.pickerMode !== 'single' && renderItems(),
            renderInput(),
            props.iconPosition === 'right' && icon),
        !props.isDisabled && !props.isReadonly && (React__namespace.createElement("div", { className: "uui-picker_toggler-actions" },
            !props.disableClear && (props.value || props.selectedRowsCount > 0) && (React__namespace.createElement(IconContainer, { cx: uuiCore.cx('uui-icon-cancel', uuiCore.uuiMarkers.clickable), isDisabled: props.isDisabled, icon: props.cancelIcon, tabIndex: -1, onClick: handleCrossIconClick, rawProps: { role: 'button', 'aria-label': 'Clear' } })),
            props.isDropdown && !(props === null || props === void 0 ? void 0 : props.minCharsToSearch) && React__namespace.createElement(IconContainer, { icon: props.dropdownIcon, flipY: props.isOpen, cx: "uui-icon-dropdown" })))));
}
...
class DataPickerRow extends React__namespace.Component {
    constructor() {
        super(...arguments);
        this.rowNode = React__namespace.createRef();
        this.handleMouseEnter = () => {
    ...
    render() {
        ...
        return (React__namespace.createElement(FlexRow, { onClick: clickHandler && (() => clickHandler(this.props)), rawProps: Object.assign(Object.assign(Object.assign({ role: 'option', 'aria-busy': this.props.isLoading, 'aria-posinset': this.props.index + 1 }, (((_a = this.props.checkbox) === null || _a === void 0 ? void 0 : _a.isVisible) && { 'aria-checked': this.props.isChecked })), (this.props.isSelectable && { 'aria-selected': this.props.isSelected })), this.props.rawProps), ref: this.rowNode, cx: [clickHandler && this.props.isFocused && uuiCore.uuiMod.focus, this.props.cx] }, this.props.renderContent()));
    }
}
...
function usePicker(props, pickerState) {
    ...
    const prevDataSourceState = uuiCore.usePrevious(dataSourceState);
    ...
    const handleSelectionValueChange = React.useCallback((newValue) => {
    ...
    const handleDataSourceValueChange = React.useCallback((newDataSourceState) => {
    ...
    React.useLayoutEffect(() => {
        ...
        if ((!prevDataSourceState && (((_b = dataSourceState.checked) === null || _b === void 0 ? void 0 : _b.length) || dataSourceState.selectedId != null))
            || (prevDataSourceState && (!isEqual__default.default(prevDataSourceState.checked, dataSourceState.checked)
            ...
            if (!isEqual__default.default(value, newValue)) {
...
function usePickerState(props) {
    const [dataSourceState, setDataSourceState] = React.useState(Object.assign({ focusedIndex: 0, topIndex: 0, visibleCount: 20 }, props.dataSourceState));
...
function usePickerInputState(props) {
    ...
    const [isSearchChanged, setIsSearchChanged] = React.useState(false);
...
function usePickerInput(props) {
    ...
    const lens = React.useMemo(() => uuiCore.Lens.onEditable({ value: dataSourceState, onValueChange: handleDataSourceValueChange }), [dataSourceState]);
    React.useEffect(() => {
    ...
    const getSearchPosition = () => {
        if (uuiCore.isMobile() && props.searchPosition !== 'none')
            return 'body';
    ...
    const handleTogglerSearchChange = React.useCallback((value) => {
    ...
    const closePickerBody = React.useCallback(() => {
    ...
    const selectedRows = React.useMemo(() => getSelectedRows(view.getSelectedRowsCount()), [view, dataSourceState.checked]);
...
function usePickerListState(props) {
    ...
    const [visibleIds, setVisibleIds] = React.useState((_a = props.visibleIds) !== null && _a !== void 0 ? _a : []);
    React.useEffect(() => {
        var _a, _b;
        ...
        if (!isEqual__default.default((_b = prevProps.current) === null || _b === void 0 ? void 0 : _b.visibleIds, props.visibleIds) && !isEqual__default.default(props.visibleIds, visibleIds)) {
...
function usePickerList(props) {
    const context = React.useContext(uuiCore.UuiContext);
    const sessionStartTime = React.useMemo(() => new Date().getTime(), []);
...
function usePickerModal(props) {
    ...
    const dataSourceStateLens = React.useMemo(() => uuiCore.Lens
...
class ErrorCatch extends React__namespace.default.Component {
    constructor(props) {
        super(props);
    }
...
ErrorCatch.contextType = uuiCore.UuiContext;

exports.Accordion = Accordion;
exports.AdaptivePanel = AdaptivePanel;
exports.Anchor = Anchor;
exports.Avatar = Avatar;
exports.AvatarStack = AvatarStack;
exports.BaseRating = BaseRating;
exports.Blocker = Blocker;
exports.Burger = Burger;
exports.Button = Button;
exports.Calendar = Calendar;
exports.CalendarPresets = CalendarPresets;
exports.Checkbox = Checkbox;
exports.Clickable = Clickable;
exports.ControlGroup = ControlGroup;
exports.DataPickerRow = DataPickerRow;
exports.DataTableCell = DataTableCell;
exports.DataTableCellContainer = DataTableCellContainer;
exports.DataTableFocusContext = DataTableFocusContext;
exports.DataTableFocusProvider = DataTableFocusProvider;
...
exports.DataTableSelectionContext = DataTableSelectionContext;
exports.DataTableSelectionProvider = DataTableSelectionProvider;
exports.Day = Day;
...
exports.MainMenuCustomElement = MainMenuCustomElement;
...
exports.PickerBodyBase = PickerBodyBase;
...
exports.Tree = Tree;
exports.UploadFileToggler = UploadFileToggler;
exports.VPanel = VPanel;
exports.YearSelection = YearSelection;
exports.applyValueToDataSourceState = applyValueToDataSourceState;
exports.dataSourceStateToValue = dataSourceStateToValue;
exports.handleDataSourceKeyboard = handleDataSourceKeyboard;
exports.i18n = i18n;
exports.useColumnsConfiguration = useColumnsConfiguration;
exports.useDataTableFocusManager = useDataTableFocusManager;
exports.useDocumentDir = useDocumentDir;
exports.usePicker = usePicker;
exports.usePickerInput = usePickerInput;
exports.usePickerList = usePickerList;
exports.usePickerModal = usePickerModal;
exports.useScrollSpy = useScrollSpy;
exports.uuiBurger = uuiBurger;
exports.uuiDaySelection = uuiDaySelection;
exports.uuiMainMenu = uuiMainMenu;
exports.uuiMonthSelection = uuiMonthSelection;
exports.uuiNumericInput = uuiNumericInput;
exports.uuiPresets = uuiPresets;
exports.uuiYearSelection = uuiYearSelection;
