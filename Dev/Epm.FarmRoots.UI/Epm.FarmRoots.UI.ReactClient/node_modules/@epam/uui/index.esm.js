...
const SearchInput = /* @__PURE__ */React__default.forwardRef((props, ref) => {
    ...
    return (React__default.createElement(IEditableDebouncer, Object.assign({}, props, { render: (iEditable) => {
            var _a;
            const defaultOnCancel = () => iEditable.onValueChange('');
            return (React__default.createElement(TextInput, Object.assign({ icon: systemIcons.search, onCancel: (_a = props.onCancel) !== null && _a !== void 0 ? _a : defaultOnCancel, type: "search", inputMode: "search", ref: ref }, textInputProps, iEditable)));
        } })));
});
...
const Alert = /* @__PURE__ */React.forwardRef((props, ref) => (React.createElement("div", Object.assign({ role: "alert", ref: ref, className: cx('uui-alert', css$1g.root, css$1g.alertWrapper, props.color && `uui-color-${props.color}`, props.cx, (props.size === '36' ? css$1g.size36 : css$1g.size48)) }, props.rawProps),
    React.createElement("div", { className: css$1g.mainPath },
        props.icon && (React.createElement("div", { className: css$1g.iconWrapper },
            React.createElement(IconContainer, { icon: props.icon, cx: css$1g.actionIcon }))),
        React.createElement("div", { className: css$1g.content },
            props.children,
            props.actions && (React.createElement("div", { className: css$1g.actionWrapper }, props.actions.map((action) => (React.createElement(LinkButton, { caption: action.name, onClick: action.action, key: action.name, cx: css$1g.actionLink, size: (props === null || props === void 0 ? void 0 : props.size) === '36' ? '24' : '30' })))))),
        props.onClose && React.createElement(IconButton, { icon: ForwardRef$Q, color: "neutral", onClick: props.onClose, cx: css$1g.closeIcon })))));
...
function DropdownMenuContainer(props) {
    ...
    return (React__default.createElement(DropdownContainer, Object.assign({}, props, { rawProps: Object.assign(Object.assign({}, props.rawProps), { role: 'menu' }), ref: menuRef, width: props.minWidth, lockProps: { onKeyDown: handleArrowKeys }, cx: [props.cx] })));
}
...
const DropdownMenuButton = /* @__PURE__ */React__default.forwardRef((props, ref) => {
    ...
    const getMenuButtonContent = () => {
        ...
        const iconElement = (React__default.createElement(IconButton, { icon: icon, color: isActive ? 'primary' : 'neutral', onClick: onIconClick, isDisabled: isDisabled, cx: cx$1(css$1e.icon, iconPosition === 'right' ? css$1e.iconAfter : css$1e.iconBefore) }));
        return (React__default.createElement(React__default.Fragment, null,
            isIconBefore && iconElement,
            React__default.createElement(Text$1, { cx: props.indent && css$1e.indent }, caption),
            isIconAfter && (React__default.createElement(React__default.Fragment, null,
                React__default.createElement(FlexSpacer, null),
                iconElement))));
    };
    const isAnchor = Boolean(link || href);
    const itemClassNames = cx$1(props.cx, css$1e.itemRoot, isDisabled && uuiMod.disabled, isActive && uuiMod.active, isOpen && uuiMod.opened);
    return isAnchor ? (React__default.createElement(Anchor$1, { cx: cx$1(css$1e.link, itemClassNames), link: link, href: href, rawProps: { role: 'menuitem', tabIndex: isDisabled ? -1 : 0 }, onClick: handleClick, isLinkActive: isActive, isDisabled: isDisabled, target: target }, getMenuButtonContent())) : (React__default.createElement(FlexRow$1, { rawProps: {
        ...
        isSelected && (React__default.createElement(React__default.Fragment, null,
            React__default.createElement(FlexSpacer, null),
            React__default.createElement(IconContainer, { icon: systemIcons.accept, cx: css$1e.selectedMark })))));
});
function DropdownMenuSplitter(props) {
    return (React__default.createElement("div", { className: cx$1(props.cx, css$1e.splitterRoot) },
        React__default.createElement("hr", { className: css$1e.splitter })));
}
function DropdownMenuHeader(props) {
    return (React__default.createElement("div", { className: cx$1('uui-dropdown-menu-header', props.cx, css$1e.headerRoot) },
        React__default.createElement("span", { className: css$1e.header }, props.caption)));
}
...
function DropdownMenuSwitchButton(props) {
    ...
    return (React__default.createElement(FlexRow$1, { cx: cx$1(props.cx, css$1e.itemRoot, isDisabled && uuiMod.disabled), onClick: () => onHandleValueChange(!isSelected), rawProps: { role: 'menuitem', onKeyDown: handleKeySelect, tabIndex: isDisabled ? -1 : 0 } },
        icon && React__default.createElement(IconContainer, { icon: icon, cx: css$1e.iconBefore }),
...
function RadioGroup(props) {
    ...
    return (React.createElement("fieldset", Object.assign({ ref: props.forwardedRef, className: cx$1(css$18.root, directionMode[direction], props.cx), onFocus: props.onFocus, onBlur: props.onBlur }, props.rawProps), props.items.map((i) => {
...
function Paginator(props) {
    const renderPaginator = (params) => {
        var _a, _b;
        return (React__default.createElement("nav", Object.assign({ role: "navigation", className: cx(css$11.root, 'uui-paginator') }, params.rawProps),
            React__default.createElement(Button, { cx: css$11[`navigation-size-${(_a = params.size) !== null && _a !== void 0 ? _a : '30'}`], size: params.size, icon: ForwardRef$v, onClick: params.goToPrev, isDisabled: params.isFirst || props.isDisabled, fill: "outline", color: "secondary" }),
            params.pages.map((page, index) => {
                var _a, _b;
                if (page.type === 'spacer') {
                    return (React__default.createElement(Button, { cx: cx(css$11[`size-${(_a = params.size) !== null && _a !== void 0 ? _a : '30'}`], css$11.spacer), size: params.size, key: `${index}_spacer`, caption: "...", fill: "ghost", color: "secondary", tabIndex: -1, isDisabled: props.isDisabled }));
                }
                else {
                    return (React__default.createElement(Button, { cx: cx(css$11[`size-${(_b = params.size) !== null && _b !== void 0 ? _b : '30'}`], css$11[`mode-${!page.isActive && 'ghost'}`]), size: params.size, key: page.pageNumber, caption: page.pageNumber, onClick: () => { var _a; return (_a = page.onClick) === null || _a === void 0 ? void 0 : _a.call(page); }, rawProps: { 'aria-current': page.isActive }, fill: (page.isActive && 'outline') || 'ghost', color: "primary", isDisabled: props.isDisabled }));
                }
            }),
            React__default.createElement(Button, { cx: css$11[`navigation-size-${(_b = params.size) !== null && _b !== void 0 ? _b : '30'}`], size: params.size, icon: ForwardRef$u, onClick: params.goToNext, isDisabled: params.isLast || props.isDisabled, fill: "outline", color: "secondary" })));
    };
...
const VirtualList = /* @__PURE__ */React.forwardRef((props, ref) => {
    ...
    const renderRows = () => {
        ...
        })) || (React.createElement("div", { className: css$16.listContainer, style: { minHeight: `${estimatedHeight}px` } },
    ...
    return (React.createElement(ScrollBars, { cx: cx$1(css$16.scrollContainer, props.cx, {
...
function CheckboxGroup(props) {
    ...
    return (React.createElement("fieldset", Object.assign({ ref: props.forwardedRef, className: cx$1(css$W.root, directionMode[direction], props.cx) }, props.rawProps), props.items.map((i) => {
        const restItemProps = __rest(i, ["id", "name", "renderName"]);
...
const TREE_SHAKEABLE_INIT = () => (Object.assign(Object.assign({}, i18n$1), { dataPickerBody: {
...
function DataPickerCell(props) {
    ...
    const getWrappedContent = () => (React.createElement("div", { className: css$T.contentWrapper }, content));
...
function PickerItem(props) {
    ...
    return (React.createElement(FlexCell, { width: "auto", cx: [css$P.root, 'uui-typography', cx] },
        React.createElement(FlexRow, { size: itemSize, cx: isMultiline && [css$P.multiline, css$P[`vertical-padding-${itemSize}`]], columnGap: "12" },
...
function PickerModal(props) {
    ...
    const renderNotFound = () => {
        return props.renderNotFound ? (props.renderNotFound({ search: dataSourceState.search, onClose: () => props.success(null) })) : (React__default.createElement("div", { className: css$Q.noFoundModalContainer },
            React__default.createElement(IconContainer, { cx: css$Q.noFoundModalContainerIcon, icon: ForwardRef$s }),
            React__default.createElement(Text, { cx: css$Q.noFoundModalContainerText, fontWeight: "600", fontSize: "16", lineHeight: "24", color: "primary", size: "36" }, i18n.dataPickerBody.noRecordsMessage),
            React__default.createElement(Text, { cx: css$Q.noFoundModalContainerText, fontSize: "12", lineHeight: "18", color: "primary", size: "36" }, i18n.dataPickerBody.noRecordsSubTitle)));
    };
...
function PickerList(props) {
    ...
    return (React__default.createElement("div", { className: cx('uui-picker-list', css$L.root) },
        !rows.length
...
const FilterPanelItemToggler = /* @__PURE__ */React.forwardRef((props, ref) => {
    ...
    const getSelectionText = () => props.selection.map((i, index) => (React.createElement(React.Fragment, { key: `${i}${index}` },
        React.createElement(Text, { color: "primary", size: props.size, cx: css$K.selection }, i),
    ...
    return (React.createElement(FlexRow$1, Object.assign({}, props, { rawProps: {
        ...
        }, cx: cx(UUI_FILTERS_PANEL_ITEM_TOGGLER, css$K.root, uuiElement.inputBox, uuiMarkers.clickable, props.isOpen && uuiMod.opened, `size-${props.size || defaultSize}`, props.cx), onClick: togglerPickerOpened, ref: ref }),
        React.createElement(FlexRow$1, { cx: css$K.titleWrapper },
            React.createElement(Text, { size: props.size, cx: css$K.title }, getTitle),
            props.selection && (React.createElement("div", { className: css$K.textWrapper },
                getSelectionText(),
                props.postfix && (React.createElement(Text, { color: "primary", size: props.size, cx: css$K.postfix }, props.postfix))))),
...
function FilterPickerBody(_a) {
    ...
    const { view, getName, isSingleSelect, getRows, dataSourceState, getFooterProps, getPickerBodyProps, getListProps, handleDataSourceValueChange, } = usePickerInput(Object.assign(Object.assign({}, props), { shouldShowBody }));
...
function StatelessDatePickerBodyComp({ renderDay, isHoliday, cx: classes, filter, rawProps, value, month, view, onValueChange, onMonthChange, onViewChange, isDisabled, }, ref) {
    ...
    const getView = () => {
        switch (view) {
            case 'MONTH_SELECTION':
                return (React__default.createElement(MonthSelection, { selectedDate: selectedDate, value: month, onValueChange: onMonthClick }));
            case 'YEAR_SELECTION':
    ...
    return (React__default.createElement("div", Object.assign({ ref: ref, className: cx$1(uuiDatePickerBodyBase.container, classes) }, rawProps),
        React__default.createElement("div", { className: cx$1(css$H.root, uuiDatePickerBody.wrapper) },
...
function FilterDatePickerBody(props) {
    ...
    return (React__default.createElement(Fragment, null,
        React__default.createElement(FlexRow, { borderBottom: true },
            React__default.createElement(DatePickerBody, { filter: props.filter, value: value, onValueChange: handleBodyChange, renderDay: props.renderDay, isHoliday: props.isHoliday, rawProps: (_a = props.rawProps) === null || _a === void 0 ? void 0 : _a.body })),
        React__default.createElement(FlexCell, { alignSelf: "stretch" },
            React__default.createElement(FlexRow, { padding: "24", vPadding: "12" },
                ...
                React__default.createElement(FlexSpacer, null),
                React__default.createElement(LinkButton, { isDisabled: !value, caption: i18n.filterToolbar.datePicker.clearCaption, onClick: () => {
...
function FilterNumericBody(props) {
    ...
    if (isInRangePredicate) {
        ...
        return (React__default.createElement("div", null,
            React__default.createElement(FlexRow, { padding: "12", alignItems: "center", spacing: "12", borderBottom: true, cx: css$F.container },
    ...
    return (React__default.createElement("div", null,
        React__default.createElement(FlexRow, { padding: "12", alignItems: "center", borderBottom: true, cx: css$F.container },
...
function FiltersToolbarItemImpl(props) {
    ...
    const renderHeader = (hideTitle) => {
        var _a;
        return (React__default.createElement("div", { className: cx(css$E.header, isPickersType && ((_a = props.showSearch) !== null && _a !== void 0 ? _a : css$E.withSearch)) },
            ...
            !(props === null || props === void 0 ? void 0 : props.isAlwaysVisible) && (React__default.createElement(LinkButton, { cx: css$E.removeButton, caption: i18n.filterToolbar.datePicker.removeCaption, onClick: removeOnclickHandler, size: "24", icon: ForwardRef$r }))));
    };
    ...
    const renderTarget = (dropdownProps) => (React__default.createElement(FilterPanelItemToggler, Object.assign({}, dropdownProps, getTogglerValue(), { title: props.title, predicateName: props.value ? predicateName : null, maxWidth: getTogglerWidth(), size: props.size })));
...
var ForwardRef$q = /*#__PURE__*/forwardRef(SvgActionAddOutline);
...
function FiltersToolbarImpl(props) {
    ...
    return (React__default.createElement(React__default.Fragment, null,
        ...
        !isAllFiltersAlwaysVisible && (React__default.createElement(PickerInput, { dataSource: dataSource, value: selectedFilters, onValueChange: onFiltersChange, selectionMode: "multi", valueType: "entity", renderRow: (props) => (React__default.createElement(DataPickerRow, Object.assign({}, props, { padding: "12", key: props.key, onCheck: (row) => {
                ...
                }, renderItem: (item, rowProps) => React__default.createElement(PickerItem, Object.assign({}, rowProps, { title: item.title })) }))), getName: (i) => i.title, renderToggler: renderAddFilterToggler, emptyValue: [], getRowOptions: getRowOptions, fixedBodyPosition: true, size: props.size, bodyCx: UUI_FILTERS_PANEL_ADD_BUTTON_BODY, ref: pickerInputRef }))));
}
...
var ForwardRef$p = /*#__PURE__*/forwardRef(SvgNavigationMoreVertOutline);
...
var ForwardRef$o = /*#__PURE__*/forwardRef(SvgNavigationRefreshOutline);
...
var ForwardRef$n = /*#__PURE__*/forwardRef(SvgActionSaveOutline);
...
var ForwardRef$m = /*#__PURE__*/forwardRef(SvgContentEditUndoOutline);
...
var ForwardRef$l = /*#__PURE__*/forwardRef(SvgActionCopyContentOutline);
...
var ForwardRef$k = /*#__PURE__*/forwardRef(SvgContentEditFill);
    ...
    const renderBody = (dropdownProps) => {
        ...
        return (React__default.createElement(DropdownMenuBody, Object.assign({}, dropdownProps),
            isPresetChanged && (React__default.createElement(React__default.Fragment, null,
                !isReadonlyPreset && (React__default.createElement(DropdownMenuButton, { key: `${props.preset.id}-save-in-current`, icon: ForwardRef$o, caption: "Save in current", onClick: saveInCurrentHandler })),
                React__default.createElement(DropdownMenuButton, { key: `${props.preset.id}-save-as-new`, icon: ForwardRef$n, caption: "Save as new", onClick: props.addPreset }),
                React__default.createElement(DropdownMenuButton, { key: `${props.preset.id}-discard`, icon: ForwardRef$m, caption: "Discard all changes", onClick: discardAllChangesHandler }),
                React__default.createElement(DropdownMenuSplitter, { key: "discard-splitter" }))),
            isRenameAvailable && (React__default.createElement(DropdownMenuButton, { key: `${props.preset.id}-rename`, icon: ForwardRef$k, caption: "Rename", onClick: props.renamePreset })),
            React__default.createElement(DropdownMenuButton, { key: `${props.preset.id}-duplicate`, icon: ForwardRef$l, caption: "Duplicate", onClick: duplicateHandler }),
...
function PresetInput(props) {
    ...
    return (React__default.createElement(FlexCell, { cx: [css$B.presetInputCell, UUI_PRESETS_PANEL_INPUT], minWidth: 180 },
...
function PresetsPanel(props) {
    ...
    const renderAddPresetButton = useCallback(() => {
        return (React__default.createElement("div", { key: "addingPresetBlock", className: css$D.addPresetContainer }, !isAddingPreset ? (React__default.createElement(Button, { cx: UUI_PRESETS_PANEL_ADD_BUTTON, size: "36", onClick: setAddingPreset, caption: i18n.presetPanel.addCaption, icon: ForwardRef$q, iconPosition: "left", fill: "ghost", color: "primary" })) : (React__default.createElement(PresetInput, { onCancel: cancelAddingPreset, onSuccess: props.createNewPreset }))));
    }, [isAddingPreset]);
    ...
    return (React__default.createElement(FlexCell, { grow: 1, minWidth: 310, rawProps: props.rawProps },
        React__default.createElement(FlexRow, { size: null, columnGap: "12", cx: css$D.presetsWrapper },
...
const TextPlaceholder = (props) => {
    ...
    return (React.createElement("div", Object.assign({ "aria-busy": true, className: cx(css$x.root, 'uui-text-placeholder') }, props.rawProps), text.map((it, index) => (React.createElement("span", { key: index, className: cx([
...
const NotificationCard = /* @__PURE__ */React__default.forwardRef((props, ref) => {
    ...
    return (React__default.createElement("div", Object.assign({ role: "alert", className: cx('uui-notification_card', props.color && `uui-color-${props.color}`, css$v.root, props.cx), ref: notificationCardNode }, props.rawProps),
        React__default.createElement("div", { className: css$v.mainPath },
            props.icon && (React__default.createElement("div", { className: css$v.iconWrapper },
                React__default.createElement(IconContainer, { size: 24, icon: props.icon }))),
            React__default.createElement("div", { className: css$v.content },
                props.children,
                props.actions && (React__default.createElement("div", { className: css$v.actionWrapper }, props.actions.map((action) => (React__default.createElement(LinkButton, { caption: action.name, onClick: action.action, key: action.name, cx: css$v.actionLink, size: "36", rawProps: action.rawProps })))))),
            props.onClose && (React__default.createElement("div", { className: css$v.closeWrapper },
                React__default.createElement(IconButton, { icon: ForwardRef$Q, color: "neutral", onClick: props.onClose, cx: css$v.closeIcon }))))));
});
...
const HintNotification = /* @__PURE__ */React__default.forwardRef((props, ref) => (React__default.createElement(NotificationCard, Object.assign({ icon: ForwardRef$h, color: "info" }, props, { ref: ref, cx: props.cx }))));
...
function ClearNotification() {
    ...
    return (React__default.createElement("div", { className: cx(css$v.notificationWrapper, css$v.clearButton) },
...
function TimePicker(props) {
    ...
    const renderBody = (bodyProps) => {
        ...
        return (!props.isDisabled && !props.isReadonly && (React__default.createElement(DropdownContainer, Object.assign({}, bodyProps, { focusLock: false }),
...
function RangeDatePickerBodyComp(props, ref) {
    ...
    const renderDay = (renderProps) => {
        return (React__default.createElement(Day, Object.assign({}, renderProps, { cx: getDayCX(renderProps.value, selectedDate) })));
    };
    const from = {
        month,
    ...
    return (React__default.createElement("div", Object.assign({ ref: ref, className: cx$1(css$q.root, uuiDatePickerBodyBase.container, props.cx) }, props.rawProps),
        React__default.createElement(FlexRow, { cx: [view === 'DAY_SELECTION' && css$q.daySelection, css$q.container], alignItems: "top" },
...
function DropMarker(props) {
    return props.isDndInProgress
        ? (React.createElement(React.Fragment, null,
            props.enableBlocker && React.createElement("div", { className: css$p.blocker }),
...
const renderCell = (props) => {
    ...
    return React.createElement(DataTableCell, Object.assign({}, props, { size: mods.size, columnsGap: mods.columnsGap }));
};
...
var ForwardRef$g = /*#__PURE__*/forwardRef(SvgTableSortAscOutline);
...
var ForwardRef$f = /*#__PURE__*/forwardRef(SvgTableSortDescOutline);
...
const SortingPanelImpl = ({ sortDirection, onSort }) => {
    ...
    return (React__default.createElement(FlexCell, { cx: cx$1(css$m.sortingPanelContainer, 'uui-dropdownMenu-body') },
        React__default.createElement(DropdownMenuButton, { isActive: sortDirection === 'asc', caption: i18n.pickerFilterHeader.sortAscending, icon: ForwardRef$g, onClick: sortAsc }),
        React__default.createElement(DropdownMenuButton, { isActive: sortDirection === 'desc', caption: i18n.pickerFilterHeader.sortDescending, icon: ForwardRef$f, onClick: sortDesc })));
};
...
var ForwardRef$e = /*#__PURE__*/forwardRef(SvgTableSwapOutline);
...
var ForwardRef$d = /*#__PURE__*/forwardRef(SvgContentFiltrationFill);
...
var ForwardRef$b = /*#__PURE__*/forwardRef(SvgNavigationCollapseAllOutline);
...
class DataTableHeaderCell extends React.Component {
    constructor() {
        ...
        this.getTooltipContent = (column) => (React.createElement("div", { className: css$l.cellTooltipWrapper },
            React.createElement(Text, { fontSize: "14", fontWeight: "600", cx: css$l.cellTooltipText }, column.caption),
            column.info && React.createElement(Text, { fontSize: "12", cx: css$l.cellTooltipText }, column.info)));
        this.getColumnCaption = () => {
            const renderTooltip = this.props.column.renderTooltip || this.getTooltipContent;
            return (React.createElement("div", { className: cx$1(css$l.captionWrapper, css$l['align-' + this.props.column.textAlign], uuiDataTableHeaderCell.uuiTableHeaderCaptionWrapper) },
                React.createElement(Tooltip, { placement: "top", color: "inverted", content: renderTooltip(this.props.column), cx: css$l.cellTooltip, openDelay: 600 },
                    React.createElement(Text, { key: "text", lineHeight: "30", fontSize: "14", size: "30", cx: cx$1(css$l.caption, this.getTextStyle(), uuiDataTableHeaderCell.uuiTableHeaderCaption) }, this.props.column.caption)),
                this.props.column.isSortable && (!this.props.column.renderFilter || this.props.sortDirection) && (React.createElement(IconButton, { key: "sort", cx: cx$1(css$l.icon, css$l.sortIcon, this.props.sortDirection && css$l.sortIconActive, uuiDataTableHeaderCell.uuiTableHeaderSortIcon), color: this.props.sortDirection ? 'neutral' : 'secondary', icon: this.props.sortDirection === 'desc' ? ForwardRef$f : this.props.sortDirection === 'asc' ? ForwardRef$g : ForwardRef$e })),
                this.props.isFilterActive && (React.createElement(IconButton, { key: "filter", cx: cx$1(css$l.icon, !this.props.sortDirection && css$l.filterIcon, uuiDataTableHeaderCell.uuiTableHeaderFilterIcon), color: "neutral", icon: ForwardRef$d })),
                this.props.column.renderFilter && (React.createElement(IconButton, { key: "dropdown", cx: cx$1(css$l.icon, css$l.dropdownIcon, uuiDataTableHeaderCell.uuiTableHeaderDropdownIcon), color: "secondary", icon: this.state.isDropdownOpen ? ForwardRef$c : ForwardRef$P }))));
        };
        this.renderHeaderCheckbox = () => {
            if (this.props.selectAll && this.props.isFirstColumn) {
                return (React.createElement(Checkbox, Object.assign({ size: +this.props.size < 36 ? '12' : '18' }, this.props.selectAll, { cx: cx$1(css$l.checkbox, uuiDataTableHeaderCell.uuiTableHeaderCheckbox) })));
            }
        };
        this.renderFoldAllIcon = () => {
            if (this.props.isFirstColumn && this.props.showFoldAll) {
                return (React.createElement(Tooltip, { content: this.props.areAllFolded
                    ...
                    React.createElement(IconButton, { color: "secondary", cx: cx$1(css$l.icon, css$l.foldAllIcon, uuiDataTableHeaderCell.uuiTableHeaderFoldAllIcon), icon: this.props.areAllFolded ? ForwardRef$a : ForwardRef$b, onClick: this.props.onFoldAll, rawProps: {
        ...
        this.renderResizeMark = (props) => {
            ...
            return (React.createElement("div", { role: "separator", onMouseDown: props.onResizeStart, className: cx$1(css$l.resizeMark, css$l[`resize-mark-${resizeMarkSize}`], uuiMarkers.draggable, uuiMarkers.clickable) }));
        };
...
function PinIconButton(props) {
    ...
    if (isPinned) {
        ...
        pinUnpinNode = (React.createElement(Tooltip, { content: iconTooltip, placement: "bottom", color: "inverted" },
            React.createElement(IconButton, { cx: cx$1(!isPinnedAlways && css$j.unpinIcon, css$j.pinTogglerIcon), icon: unpinIcon, onClick: unpinClickHandler, isDisabled: isPinnedAlways, color: "primary" })));
    }
    else {
        pinUnpinNode = (React.createElement("span", { style: { display: 'flex', gap: '12px' } },
            React.createElement(Tooltip, { content: i18nLocal.pinColumnToTheLeftButton, placement: "bottom", color: "inverted" },
                React.createElement(IconButton, { cx: css$j.pinTogglerIcon, icon: ForwardRef$7, onClick: () => onTogglePin('left'), isDisabled: isPinnedAlways, color: undefined })),
            React.createElement(Tooltip, { content: i18nLocal.pinColumnToTheRightButton, placement: "bottom", color: "inverted" },
                React.createElement(IconButton, { cx: css$j.pinTogglerIcon, icon: ForwardRef$6, onClick: () => onTogglePin('right'), isDisabled: isPinnedAlways, color: undefined }))));
    }
    return (React.createElement("span", null, pinUnpinNode));
}
...
const ColumnRow = /* @__PURE__ */React.memo(function ColumnRow(props) {
    ...
    const renderContent = (dndActorParams) => {
        const wrapperClasses = cx$1(styles.rowWrapper, !isPinned && styles.notPinned);
        ...
        return (React.createElement(FlexRow, { size: "30", cx: wrapperClasses, ref: dndActorParams.ref, rawProps: Object.assign({}, restEventHandlers) },
            React.createElement(DragHandle, { dragHandleIcon: ForwardRef$5, rawProps: { onTouchStart, onPointerDown }, isDisabled: !isDndAllowed, cx: cx$1(styles.dragHandle, !isDndAllowed && styles.dndDisabled) }),
...
const renderGroupTitle = (title, amount) => (React.createElement(FlexRow, { size: "24", padding: "24", columnGap: "6", cx: styles$1.groupTitle },
    React.createElement(Text, { cx: styles$1.groupTitleText, fontWeight: "600", lineHeight: "24", fontSize: "14" }, title),
    React.createElement(CountIndicator, { caption: amount, color: "neutral", size: "18" }),
    React.createElement(FlexSpacer, null)));
function ColumnsConfigurationModal(props) {
    ...
    const renderVisible = () => {
        ...
        return (React.createElement(React.Fragment, null,
            ...
            hasDividerBelowPinnedLeft && React.createElement("div", { className: styles$1.hDivider }),
            ...
            hasDividerAbovePinnedRight && React.createElement("div", { className: styles$1.hDivider }),
    ...
    return (React.createElement(ModalBlocker, Object.assign({}, modalProps),
        React.createElement(ModalWindow, { cx: styles$1.modal, height: "95dvh", maxHeight: "95dvh" },
            React.createElement(ModalHeader, { title: i18n$1.configureColumnsTitle, onClose: close }),
            React.createElement(FlexRow, { padding: "24", borderBottom: true, columnGap: "12", cx: styles$1.searchArea },
                ...
                React.createElement(Dropdown, { closeOnTargetClick: true, renderBody: () => (React.createElement(DropdownMenuBody, { minWidth: 100 },
                        ...
                        React.createElement(DropdownMenuButton, { caption: i18n$1.selectAllButton, onClick: checkAll }))), renderTarget: (props) => React.createElement(Button, Object.assign({}, props, { fill: "none", icon: ForwardRef$p, size: "30", color: "secondary", isDropdown: false })) })),
...
function SubGroup(props) {
    ...
    if (items.length) {
        const content = (React.createElement(FlexRow, { cx: styles$1.groupItems, size: "30" }, items.map((c) => (React.createElement(ColumnRow, { column: c, key: c.key, renderItem: renderItem })))));
        if (isCollapsible) {
            const renderTitle = (isOpened) => {
                const toggleIcon = isOpened ? ForwardRef$P : ForwardRef$u;
                return (React.createElement("span", { className: cx$1(styles$1.subgroupTitle) },
                    React.createElement(IconContainer, { size: 18, icon: toggleIcon, flipY: false }),
                    title));
            };
            return (React.createElement(Accordion$1, { value: isExpanded, onValueChange: setIsExpanded, renderTitle: renderTitle, cx: styles$1.subgroupAccordion }, content));
        }
        return content;
    }
    return null;
...
function DataTable(props) {
    ...
    const defaultRenderRow = React.useCallback((rowProps) => {
        return (React.createElement(DataTableRow, Object.assign({ key: rowProps.rowKey, size: props.size || '36', columnsGap: props.columnsGap || DEFAULT_COLUMN_GAP, borderBottom: props.border }, rowProps, { cx: css$h.cell })));
    }, []);
    ...
    const renderNoResultsBlock = React.useCallback(() => {
        ...
        return (React.createElement("div", { className: css$h.noResults }, props.renderNoResultsBlock ? ((_a = props.renderNoResultsBlock) === null || _a === void 0 ? void 0 : _a.call(props)) : (React.createElement(React.Fragment, null,
            React.createElement(IconContainer, { cx: css$h.noResultsIcon, icon: ForwardRef$4 }),
            React.createElement(Text, { cx: css$h.noResultsTitle, fontSize: "24", lineHeight: "30", color: "primary", fontWeight: "600" }, i18n.tables.noResultsBlock.title),
    ...
    return (React.createElement(DataTableSelectionProvider, { onCopy: props.onCopy, rows: rows, columns: columns },
        React.createElement(DataTableFocusProvider, { dataTableFocusManager: props.dataTableFocusManager },
            React.createElement(VirtualList, { value: props.value, onValueChange: props.onValueChange, onScroll: props.onScroll, rowsCount: props.rowsCount, renderRows: renderRowsContainer, cx: cx$1(css$h.table, 'uui-dt-vars'), isLoading: props.isReloading, rowsSelector: "[role=row]", rawProps: {
                    role: 'table',
...
var ForwardRef$3 = /*#__PURE__*/forwardRef(SvgNavigationOpenSideMenuOutline);

function applyBurgerMods() {
    return [cx(css$f.root, 'uui-burger')];
}
...
function BurgerGroupHeader(props) {
    return (React.createElement("div", { className: cx(css$c.root, css$c.groupHeader, 'uui-burger-group-header') },
        React.createElement("hr", { className: css$c.line }),
...
const MainMenuButton = /* @__PURE__ */React.forwardRef((props, ref) => {
    ...
    return (React.createElement(Clickable, Object.assign({}, clickableProps, { rawProps: Object.assign({ role: 'menuitem', 'aria-haspopup': props.isDropdown, 'aria-expanded': props.isOpen }, props.rawProps), cx: [
            css$b.root,
...
const MainMenu = /* @__PURE__ */withMods(uuiComponents.MainMenu, applyMainMenuMods, () => ({
    Burger,
    MainMenuDropdown,
}));
...
function DropSpot(props) {
    const getInfoText = typeof props.infoText === 'string'
        ? (React.createElement(Text, { lineHeight: "24", size: "24", fontSize: "14", color: "tertiary" }, props.infoText)) : props === null || props === void 0 ? void 0 : props.infoText;
    const renderAttachmentArea = (params) => {
        return (React.createElement("div", Object.assign({ className: cx$1(css$4.root, props.cx, params.isDragStart && css$4.dropStart, params.isDraggingOver && css$4.dropOver) }, props.rawProps),
            React.createElement("div", Object.assign({}, params.eventHandlers, { className: css$4.dropArea }),
                React.createElement(FlexRow, { size: "24" },
                    ...
                    React.createElement(UploadFileToggler, { onFilesAdded: props.onUploadFiles, render: (props) => (React.createElement(RichTextView, null,
                            React.createElement(LinkButton, Object.assign({ caption: i18n.fileUpload.browse }, props, { cx: css$4.link })))), accept: props.accept, single: props.single })),
                getInfoText)));
    };
...
const SvgCircleProgress = /* @__PURE__ */React.forwardRef((props, ref) => {
    ...
    return (React.createElement("svg", Object.assign({ className: css$2.root, width: props.size, height: props.size, ref: ref }, props.rawProps),
...
const FileCard = /* @__PURE__ */React.forwardRef((props, ref) => {
    ...
    return (React.createElement(FlexCell, { ref: ref, cx: cx$1(css$3.root, 'uui-file_card', (isLoading || (error === null || error === void 0 ? void 0 : error.isError)) && uuiMod.loading, componentCx, (error === null || error === void 0 ? void 0 : error.isError) && uuiMod.error), minWidth: width, width: !width ? '100%' : undefined },
        React.createElement(FlexRow, { size: "36", alignItems: "top", columnGap: "6" },
            ...
            React.createElement(FlexCell, { width: "100%" },
                React.createElement(Text, { size: "18", fontSize: "14", lineHeight: "18", color: (progress < 100 || (error === null || error === void 0 ? void 0 : error.isError)) ? 'tertiary' : 'primary', cx: css$3.fileName }, fileName),
...
function ErrorHandler(props) {
    ...
    const showNotifications = (errors) => {
        errors.forEach((c) => {
            if (props.onNotificationError) {
                ...
                uuiNotifications.show((notificationProps) => (React__default.createElement(ErrorNotification, Object.assign({}, notificationProps),
    ...
    const renderRecoveryBlocker = (errorInform) => {
        ...
        return (React__default.createElement(ModalBlocker, { key: "recovery-blocker", cx: css.modalBlocker, isActive: true, zIndex: 100500, success: () => { }, abort: () => { } },
                ...
                React__default.createElement(FlexRow, { padding: "24", cx: css.recoveryMessage },
                    React__default.createElement(FlexCell, { grow: 1 },
                        ...
                        isAuthLost && (React__default.createElement(Text, { color: "tertiary" },
                            ...
                            ' ',
                            React__default.createElement(Anchor, { href: uuiApi.apiReloginPath, target: "_blank" }, "link"),
                            ".")))))));
    };
    const renderErrorPage = (errorInform) => {
        return React__default.createElement(ErrorPage, Object.assign({ cx: props.cx }, errorInform));
    };
    if (errorType === 'error') {
        uuiModals.closeAll();
    ...
    return (React__default.createElement(ErrorCatch, null,
        props.children,
